...
namespace NeptuneEvo.VehicleModel
{
    public class DonateAutoRoom : Script
    {
        ...
        public void Event_ResourceStart()
        {
            ...
            PedSystem.Repository.CreateQuest("a_f_m_fatbla_01", NpcBuyPosition, NpcBuyRotation, title: "~y~NPC~w~ DonateAutoroom", colShapeEnums: ColShapeEnums.DonateAutoroom);
        }
