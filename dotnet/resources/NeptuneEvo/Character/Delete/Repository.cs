            ...
            try
            {
                ...
                NAPI.Task.Run(() =>
                {
                    foreach (var charData in chars)
                    {
                        if (!bansUUID.Contains(charData.Uuid))
                        {
                            BusinessManager.changeOwner($"{charData.Firstname}_{charData.Lastname}", "State");
                            ...
                            if (target != null)
                            {
                                ...
                                if (targetAccountData != null)
                                {
                                    ...
                                    GameLog.AccountLog(targetAccountData.Login, targetAccountData.HWID, targetAccountData.IP, targetAccountData.SocialClub, $"Deleting a character {charData.Firstname}_{charData.Lastname}");
