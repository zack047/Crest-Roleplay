            ...
            try
            {
                ...
                NAPI.Task.Run(() =>
                {
                    try
                    {
                        ...
                        GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, $"A character is created {characterData.FirstName} {characterData.LastName}");
