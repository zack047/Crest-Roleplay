    ...
    public class EventsMenu : Script
    {
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                CustomColShape.CreateSphereColShape(new Vector3(-265.74036, -2017.554, 30.145578), 7f, 0, ColShapeEnums.EventsMenu);
                //PedSystem.Repository.CreateQuest("a_m_m_afriamer_01", new Vector3(-486.10715, -399.39944, 34.546597), -47.65183f, title: "~y~NPC~w~ Sanya\nProfessional Gambler");
                PedSystem.Repository.CreateQuest("a_m_m_afriamer_01", new Vector3(-265.74036, -2017.554, 30.145578), -127.815f, title: "~y~NPC~w~ Sanya\nEvent Manager");
