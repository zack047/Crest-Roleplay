    ...
    public class Repository
    {
        ...
        public void InPatrolling(ExtPlayer player, int index)
        {
            try
            {
                ...
                if (isEnd)
                {
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"You have completed your patrol.", 7000);
                }
                else
                {
                    index += 1;
        ...
        public static bool CreatePatrolling(ExtPlayer player, bool isAir)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"You took the task, the marker is already on the map.", 7000);
                return true;
