        ...
        public void OnResourceStartHandler()
        {
            try
            {
                ...
                { 
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Elevator"), new Vector3(FirstNewsLiftTP[i].X, FirstNewsLiftTP[i].Y, FirstNewsLiftTP[i].Z), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                ...
                { 
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Elevator"), new Vector3(SecondNewsLiftTP[i].X, SecondNewsLiftTP[i].Y, SecondNewsLiftTP[i].Z), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                    NAPI.Marker.CreateMarker(1, SecondNewsLiftTP[i] - new Vector3(0, 0, 1.25), new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220)); 
                }

                PedSystem.Repository.CreateQuest("ig_molly", new Vector3(-586.7227, -921.56085, 23.869083), 137.71083f, title: "~y~NPC~w~ Jennifer", colShapeEnums: ColShapeEnums.FracLSNews);
                PedSystem.Repository.CreateQuest("ig_englishdave_02", new Vector3(-588.256, -936.6138, 23.867977), -4.159257f, title: "~y~NPC~w~ Journalist Shamanchik\nTo call an employee", colShapeEnums: ColShapeEnums.CallNewsMember);
            }
            catch (Exception e)
            {
