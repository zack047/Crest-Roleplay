...
namespace NeptuneEvo.Fractions
{
    class Manager : Script
    {
        ...
        public static void AcceptCallFractionMemberDialog(ExtPlayer player, int fracId)
        {
            try
            {
                ...
                EventSys.SendCoolMsg(player, "Successfully", "Employee call", $"{LangFunc.GetText(LangType.Ru, DataName.PlayerSucCallGov)}", "", 10000);
        ...
        public static Dictionary<int, FracMatsData> FractionDataMats = new Dictionary<int, FracMatsData>()
        {
            ...
            { 0, new FracMatsData(0, "Услуга по отмыву денег", "inv-item-briefcase", "", "Money laundering") },
            { 1, new FracMatsData(1, Chars.Repository.ItemsInfo[ItemId.BagWithDrill].Name, Chars.Repository.ItemsInfo[ItemId.BagWithDrill].Icon, $"{Main.BlackMarketDrill}$", "Bag with drill") },
            { 2, new FracMatsData(2, Chars.Repository.ItemsInfo[ItemId.Lockpick].Name, Chars.Repository.ItemsInfo[ItemId.Lockpick].Icon, $"{Main.BlackMarketLockPick}$", "Lockpick") },
            { 3, new FracMatsData(3, Chars.Repository.ItemsInfo[ItemId.ArmyLockpick].Name, Chars.Repository.ItemsInfo[ItemId.ArmyLockpick].Icon, $"{Main.BlackMarketArmyLockPick}$", "Army lockpick") },
            { 4, new FracMatsData(4, Chars.Repository.ItemsInfo[ItemId.Cuffs].Name, Chars.Repository.ItemsInfo[ItemId.Cuffs].Icon, $"{Main.BlackMarketCuffs}$", "Cable ties") },
            { 5, new FracMatsData(5, Chars.Repository.ItemsInfo[ItemId.Pocket].Name, Chars.Repository.ItemsInfo[ItemId.Pocket].Icon, $"{Main.BlackMarketPocket}$", "Sack") },
            { 6, new FracMatsData(6, "Понизить розыск", "sm-icon-wanted", $"{Main.BlackMarketWanted}$", "Clear wanteds") },
            { 7, new FracMatsData(7, Chars.Repository.ItemsInfo[ItemId.BodyArmor].Name, Chars.Repository.ItemsInfo[ItemId.BodyArmor].Icon, $"150 мат.", "Armor") },
            { 69, new FracMatsData(69, "Взломать наручники", "sm-icon-arrested", $"{Main.BlackMarketUnCuff}$", "Crack handcuffs") },
            { 78, new FracMatsData(78, "Лицензия на оружие", "inv-item-modifications", $"{Main.BlackMarketGunLic}$", "Weapons license") },
            { 79, new FracMatsData(79, "Мед. карта", Chars.Repository.ItemsInfo[ItemId.Note].Icon, $"{Main.BlackMarketMedCard}$", "Medical card") },
            { 80, new FracMatsData(80, "QR-код", Chars.Repository.ItemsInfo[ItemId.Note].Icon, $"{Main.BlackQrFake}$", "QR-Code") },
            { 81, new FracMatsData(81, "Радиоперехватчик", Chars.Repository.ItemsInfo[ItemId.RadioInterceptor].Icon, $"{Main.BlackRadioInterceptord}$", "Radio Interceptor") },

            //Для фракций
            { 8, new FracMatsData(8, Chars.Repository.ItemsInfo[ItemId.Nightstick].Name, Chars.Repository.ItemsInfo[ItemId.Nightstick].Icon, null, "Nightstick") },
            { 9, new FracMatsData(9, Chars.Repository.ItemsInfo[ItemId.StunGun].Name, Chars.Repository.ItemsInfo[ItemId.StunGun].Icon, null, "Stun Gun") },
            { 10, new FracMatsData(10, Chars.Repository.ItemsInfo[ItemId.CombatPistol].Name, Chars.Repository.ItemsInfo[ItemId.CombatPistol].Icon, null, "Combat Pistol") },
            { 11, new FracMatsData(11, Chars.Repository.ItemsInfo[ItemId.SMG].Name, Chars.Repository.ItemsInfo[ItemId.SMG].Icon, null, "SMG") },
            { 12, new FracMatsData(12, Chars.Repository.ItemsInfo[ItemId.PumpShotgun].Name, Chars.Repository.ItemsInfo[ItemId.PumpShotgun].Icon, null, "Pump Shotgun") },
            { 13, new FracMatsData(13, Chars.Repository.ItemsInfo[ItemId.CombatPDW].Name, Chars.Repository.ItemsInfo[ItemId.CombatPDW].Icon, null, "Combat PDW") },
            { 14, new FracMatsData(14, Chars.Repository.ItemsInfo[ItemId.CarbineRifle].Name, Chars.Repository.ItemsInfo[ItemId.CarbineRifle].Icon, null, "Carbine Rifle") },
            { 15, new FracMatsData(15, Chars.Repository.ItemsInfo[ItemId.HeavySniper].Name, Chars.Repository.ItemsInfo[ItemId.HeavySniper].Icon, null, "Heavy Sniper") },
            { 16, new FracMatsData(16, Chars.Repository.ItemsInfo[ItemId.AdvancedRifle].Name, Chars.Repository.ItemsInfo[ItemId.AdvancedRifle].Icon, null, "Advanced Rifle") },
            { 17, new FracMatsData(17, Chars.Repository.ItemsInfo[ItemId.Gusenberg].Name, Chars.Repository.ItemsInfo[ItemId.Gusenberg].Icon, null, "Gusenberg") },
            { 18, new FracMatsData(18, Chars.Repository.ItemsInfo[ItemId.CombatMG].Name, Chars.Repository.ItemsInfo[ItemId.CombatMG].Icon, null, "Combat MG") },
            { 19, new FracMatsData(19, Chars.Repository.ItemsInfo[ItemId.PistolAmmo].Name, Chars.Repository.ItemsInfo[ItemId.PistolAmmo].Icon, null, "Pistol Ammo") },
            { 20, new FracMatsData(20, Chars.Repository.ItemsInfo[ItemId.ShotgunsAmmo].Name, Chars.Repository.ItemsInfo[ItemId.ShotgunsAmmo].Icon, null, "Shotgun Ammo") },
            { 21, new FracMatsData(21, Chars.Repository.ItemsInfo[ItemId.SMGAmmo].Name, Chars.Repository.ItemsInfo[ItemId.SMGAmmo].Icon, null, "SMG Ammo") },
            //{ 22, new FracMatsData(22, $"{Chars.Repository.ItemsInfo[ItemId.SMGAmmo].Name} x100", Chars.Repository.ItemsInfo[ItemId.SMGAmmo].Icon, null, "RealName") },
            { 23, new FracMatsData(23, Chars.Repository.ItemsInfo[ItemId.RiflesAmmo].Name, Chars.Repository.ItemsInfo[ItemId.RiflesAmmo].Icon, null, "Rifle Ammo") },
            { 24, new FracMatsData(24, Chars.Repository.ItemsInfo[ItemId.SniperAmmo].Name, Chars.Repository.ItemsInfo[ItemId.SniperAmmo].Icon, null, "Sniper Ammo") },



            { 25, new FracMatsData(25, "Бейдж", "sm-icon-documents", null, "Badge") },
            { 26, new FracMatsData(26, "Сдать бронежилет", "sm-icon-remove-armour", null, "Surrender your bulletproof vest") },

            { 27, new FracMatsData(27, "Угон автотранспорта", "sm-icon-hijacking", null, "Vehicle theft") },
            { 28, new FracMatsData(28, "Перевозка автотранспорта", "sm-icon-transportation", null, "Transportation of motor vehicles") },


            { 29, new FracMatsData(29, "Перевозка оружия", "sm-icon-truck-ammo", null, "Transportation of weapons") },
            { 30, new FracMatsData(30, "Перевозка денег", "sm-icon-truck-cash", null, "Transportation of money") },
            { 31, new FracMatsData(31, "Перевозка трупов", "sm-icon-truck-corpses", null, "Transportation of corpses") },


            { 32, new FracMatsData(32, Chars.Repository.ItemsInfo[ItemId.HealthKit].Name, Chars.Repository.ItemsInfo[ItemId.HealthKit].Icon, null, "Medkit") },
            { 33, new FracMatsData(33, Chars.Repository.ItemsInfo[ItemId.BodyArmor].Name, Chars.Repository.ItemsInfo[ItemId.BodyArmor].Icon, null, "Bodyarmor") },


            { 34, new FracMatsData(34, Chars.Repository.ItemsInfo[ItemId.CeramicPistol].Name, Chars.Repository.ItemsInfo[ItemId.CeramicPistol].Icon, null, "Ceramic Pistol") },
            { 35, new FracMatsData(35, Chars.Repository.ItemsInfo[ItemId.HeavyPistol].Name, Chars.Repository.ItemsInfo[ItemId.HeavyPistol].Icon, null, "Heavy Pistol") },
            { 36, new FracMatsData(36, Chars.Repository.ItemsInfo[ItemId.VintagePistol]   .Name, Chars.Repository.ItemsInfo[ItemId.VintagePistol].Icon, null, "Vintage Pistol") },
            { 37, new FracMatsData(37, Chars.Repository.ItemsInfo[ItemId.Pistol50].Name, Chars.Repository.ItemsInfo[ItemId.Pistol50].Icon, null, "Pistol 50") },
            { 38, new FracMatsData(38, Chars.Repository.ItemsInfo[ItemId.PumpShotgun].Name, Chars.Repository.ItemsInfo[ItemId.PumpShotgun].Icon, null, "Pump Shotgun") },
            { 39, new FracMatsData(38, Chars.Repository.ItemsInfo[ItemId.SMGMk2].Name, Chars.Repository.ItemsInfo[ItemId.SMGMk2].Icon, null, "SMGMk2") },
            { 40, new FracMatsData(40, Chars.Repository.ItemsInfo[ItemId.MachinePistol].Name, Chars.Repository.ItemsInfo[ItemId.MachinePistol].Icon, null, "Machine Pistol") },
            { 41, new FracMatsData(41, Chars.Repository.ItemsInfo[ItemId.MiniSMG].Name, Chars.Repository.ItemsInfo[ItemId.MiniSMG].Icon, null, "Mini SMG") },
            { 42, new FracMatsData(42, Chars.Repository.ItemsInfo[ItemId.CompactRifle].Name, Chars.Repository.ItemsInfo[ItemId.CompactRifle].Icon, null, "Compact Rifle") },
            { 43, new FracMatsData(43, Chars.Repository.ItemsInfo[ItemId.AssaultRifle].Name, Chars.Repository.ItemsInfo[ItemId.AssaultRifle].Icon, null, "Assault Rifle") },
            { 44, new FracMatsData(44, Chars.Repository.ItemsInfo[ItemId.PistolMk2].Name, Chars.Repository.ItemsInfo[ItemId.PistolMk2].Icon, null, "Pistol MK2") },
            //{ 45, new FracMatsData(45, Chars.Repository.ItemsInfo[ItemId.CeramicPistol].Name, Chars.Repository.ItemsInfo[ItemId.CeramicPistol].Icon, null, "RealName") },
            { 46, new FracMatsData(46, Chars.Repository.ItemsInfo[ItemId.SNSPistolMk2].Name, Chars.Repository.ItemsInfo[ItemId.SNSPistolMk2].Icon, null, "SNS Pistol MK2") },
            { 47, new FracMatsData(47, Chars.Repository.ItemsInfo[ItemId.DoubleBarrelShotgun].Name, Chars.Repository.ItemsInfo[ItemId.DoubleBarrelShotgun].Icon, null, "Double Barrel Shotgun") },
            { 48, new FracMatsData(48, Chars.Repository.ItemsInfo[ItemId.SawnOffShotgun].Name, Chars.Repository.ItemsInfo[ItemId.SawnOffShotgun].Icon, null, "Sawn-Off Shotgun") },
            { 49, new FracMatsData(49, Chars.Repository.ItemsInfo[ItemId.PumpShotgunMk2].Name, Chars.Repository.ItemsInfo[ItemId.PumpShotgunMk2].Icon, null, "Pump Shotgun MK2") },
            { 50, new FracMatsData(50, Chars.Repository.ItemsInfo[ItemId.SweeperShotgun].Name, Chars.Repository.ItemsInfo[ItemId.SweeperShotgun].Icon, null, "Sweeper Shotgun") },
            { 51, new FracMatsData(51, Chars.Repository.ItemsInfo[ItemId.MicroSMG].Name, Chars.Repository.ItemsInfo[ItemId.MicroSMG].Icon, null, "Micro SMG") },
            { 52, new FracMatsData(52, Chars.Repository.ItemsInfo[ItemId.SMGMk2].Name, Chars.Repository.ItemsInfo[ItemId.SMGMk2].Icon, null, "SMG MK2") },
            { 53, new FracMatsData(53, Chars.Repository.ItemsInfo[ItemId.AssaultRifleMk2].Name, Chars.Repository.ItemsInfo[ItemId.AssaultRifleMk2].Icon, null, "Assault Rifle MK2") },
            { 54, new FracMatsData(54, Chars.Repository.ItemsInfo[ItemId.BullpupRifle].Name, Chars.Repository.ItemsInfo[ItemId.BullpupRifle].Icon, null, "Bullpup Rifle") },
            { 55, new FracMatsData(55, Chars.Repository.ItemsInfo[ItemId.APPistol].Name, Chars.Repository.ItemsInfo[ItemId.APPistol].Icon, null, "APPistol") },
            { 56, new FracMatsData(56, Chars.Repository.ItemsInfo[ItemId.GrenadeLauncherSmoke].Name, Chars.Repository.ItemsInfo[ItemId.GrenadeLauncherSmoke].Icon, null, "Grenade Launcher Smoke") },
            { 57, new FracMatsData(57, Chars.Repository.ItemsInfo[ItemId.AssaultShotgun].Name, Chars.Repository.ItemsInfo[ItemId.AssaultShotgun].Icon, null, "Assault Shotgun") },
            { 58, new FracMatsData(58, Chars.Repository.ItemsInfo[ItemId.AssaultSMG].Name, Chars.Repository.ItemsInfo[ItemId.AssaultSMG].Icon, null, "Assault SMG") },
            //59
            { 60, new FracMatsData(60, Chars.Repository.ItemsInfo[ItemId.CombatMGMk2].Name, Chars.Repository.ItemsInfo[ItemId.CombatMGMk2].Icon, null, "Combat MG MK2") },
            { 61, new FracMatsData(61, Chars.Repository.ItemsInfo[ItemId.CarbineRifleMk2].Name, Chars.Repository.ItemsInfo[ItemId.CarbineRifleMk2].Icon, null, "Carbine Rifle MK2") },
            { 62, new FracMatsData(62, Chars.Repository.ItemsInfo[ItemId.BullpupRifleMk2].Name, Chars.Repository.ItemsInfo[ItemId.BullpupRifleMk2].Icon, null, "Bullpup MK2") },
            { 63, new FracMatsData(63, Chars.Repository.ItemsInfo[ItemId.MarksmanRifleMk2].Name, Chars.Repository.ItemsInfo[ItemId.MarksmanRifleMk2].Icon, null, "Marksman Rifle MK2") },
            { 64, new FracMatsData(64, Chars.Repository.ItemsInfo[ItemId.HeavyShotgun].Name, Chars.Repository.ItemsInfo[ItemId.HeavyShotgun].Icon, null, "Heavy Shotgun") },
            { 65, new FracMatsData(65, Chars.Repository.ItemsInfo[ItemId.BullpupShotgun].Name, Chars.Repository.ItemsInfo[ItemId.BullpupShotgun].Icon, null, "Bullpup Shotgun") },
            { 66, new FracMatsData(66, Chars.Repository.ItemsInfo[ItemId.SpecialCarbine].Name, Chars.Repository.ItemsInfo[ItemId.SpecialCarbine].Icon, null, "Special Carbine") },
            { 67, new FracMatsData(67, Chars.Repository.ItemsInfo[ItemId.SpecialCarbineMk2].Name, Chars.Repository.ItemsInfo[ItemId.SpecialCarbineMk2].Icon, null, "Special Carbine MK2") },
            { 68, new FracMatsData(68, Chars.Repository.ItemsInfo[ItemId.SniperRifle].Name, Chars.Repository.ItemsInfo[ItemId.SniperRifle].Icon, null, "Sniper Rifle") },

            //Магазин фейверков
            { 70, new FracMatsData(70, Chars.Repository.ItemsInfo[ItemId.Firework1].Name, Chars.Repository.ItemsInfo[ItemId.Firework1].Icon, Main.PricesSettings.FireworkPrices[0]+"$", "Firework") },
            { 71, new FracMatsData(71, Chars.Repository.ItemsInfo[ItemId.Firework2].Name, Chars.Repository.ItemsInfo[ItemId.Firework2].Icon, Main.PricesSettings.FireworkPrices[1]+"$", "Firework") },
            { 72, new FracMatsData(72, Chars.Repository.ItemsInfo[ItemId.Firework3].Name, Chars.Repository.ItemsInfo[ItemId.Firework3].Icon, Main.PricesSettings.FireworkPrices[2]+"$", "Firework") },
            { 73, new FracMatsData(73, Chars.Repository.ItemsInfo[ItemId.Firework4].Name, Chars.Repository.ItemsInfo[ItemId.Firework4].Icon, Main.PricesSettings.FireworkPrices[3]+"$", "Firework") },

            //Охотничий магазин
            { 74, new FracMatsData(74, Chars.Repository.ItemsInfo[ItemId.WorkAxe].Name, Chars.Repository.ItemsInfo[ItemId.WorkAxe].Icon, Main.PricesSettings.InstrumentPrices[0]+"$", "Working Axe") },
            { 75, new FracMatsData(75, Chars.Repository.ItemsInfo[ItemId.Pickaxe1].Name, Chars.Repository.ItemsInfo[ItemId.Pickaxe1].Icon, Main.PricesSettings.InstrumentPrices[1]+"$", "Pickaxe") },
            { 76, new FracMatsData(76, Chars.Repository.ItemsInfo[ItemId.Pickaxe2].Name, Chars.Repository.ItemsInfo[ItemId.Pickaxe2].Icon, Main.PricesSettings.InstrumentPrices[2]+"$", "Pickaxe") },
            { 77, new FracMatsData(77, Chars.Repository.ItemsInfo[ItemId.Pickaxe3].Name, Chars.Repository.ItemsInfo[ItemId.Pickaxe3].Icon, Main.PricesSettings.InstrumentPrices[3]+"$", "Pickaxe") },
            
            // Предметы новые у пд
            { 82, new FracMatsData(82, Chars.Repository.ItemsInfo[ItemId.Konus].Name, Chars.Repository.ItemsInfo[ItemId.Konus].Icon, null, "Cone") },
            { 83, new FracMatsData(83, Chars.Repository.ItemsInfo[ItemId.Konuss].Name, Chars.Repository.ItemsInfo[ItemId.Konuss].Icon, null, "Luminous cone") },
            { 84, new FracMatsData(84, Chars.Repository.ItemsInfo[ItemId.Otboynik1].Name, Chars.Repository.ItemsInfo[ItemId.Otboynik1].Icon, null, "Rebound") },
            { 85, new FracMatsData(85, Chars.Repository.ItemsInfo[ItemId.Otboynik2].Name, Chars.Repository.ItemsInfo[ItemId.Otboynik2].Icon, null, "Rebound") },
            { 86, new FracMatsData(86, Chars.Repository.ItemsInfo[ItemId.Dontcross].Name, Chars.Repository.ItemsInfo[ItemId.Dontcross].Icon, null, "Dont cross") },
            { 87, new FracMatsData(87, Chars.Repository.ItemsInfo[ItemId.Stop].Name, Chars.Repository.ItemsInfo[ItemId.Stop].Icon, null, "STOP sign") },
            { 88, new FracMatsData(88, Chars.Repository.ItemsInfo[ItemId.NetProezda].Name, Chars.Repository.ItemsInfo[ItemId.NetProezda].Icon, null, "No Passage sign") },
            { 89, new FracMatsData(89, Chars.Repository.ItemsInfo[ItemId.Kpp].Name, Chars.Repository.ItemsInfo[ItemId.Kpp].Icon, null, "CHECKPOINT") },
            { 90, new FracMatsData(90, Chars.Repository.ItemsInfo[ItemId.Zabor1].Name, Chars.Repository.ItemsInfo[ItemId.Zabor1].Icon, null, "Large fence") },
            { 91, new FracMatsData(91, Chars.Repository.ItemsInfo[ItemId.Zabor2].Name, Chars.Repository.ItemsInfo[ItemId.Zabor2].Icon, null, "Small fence") },
            { 92, new FracMatsData(92, Chars.Repository.ItemsInfo[ItemId.Airlight].Name, Chars.Repository.ItemsInfo[ItemId.Airlight].Icon, null, "Nightlight") },
            { 93, new FracMatsData(93, Chars.Repository.ItemsInfo[ItemId.Camera1].Name, Chars.Repository.ItemsInfo[ItemId.Camera1].Icon, null, "CCTV camera") },
            { 94, new FracMatsData(94, Chars.Repository.ItemsInfo[ItemId.Camera2].Name, Chars.Repository.ItemsInfo[ItemId.Camera2].Icon, null, "CCTV camera") },
        };
        ...
        public class FracMatsData
        {
            ...
            public FracMatsData(int Id, string Name, string Icon, string Price, string RealName, int ItemId = 0)
            {
                this.Id = Id;
                this.Name = Name;
                this.Icon = Icon;
        ...
        public static void Event_WCraft(ExtPlayer player, int frac, int cat, int index)
        {
            try
            {
                ...
                if (frac == (int)Models.Fractions.MERRYWEATHER)
                {
                    switch (selected)
                    {
                        ...
                        case "CombatPistol":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Force {selected} for MerryWeather is available from Rank 2.", 3000);
                                return;
                            }
                            break;
                        case "HeavyPistol":
                        case "Pistol50":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Force {selected} for MerryWeather is available from Rank 3.", 3000);
                                return;
                            }
                            break;
                        case "SMG":
                        ...
                        case "SawnOffShotgun":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Force {selected} for MerryWeather available from rank 4.", 3000);
                                return;
                            }
                            break;
                        case "PumpShotgunMk2":
                        ...
                        case "SMGMk2":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Force {selected} for MerryWeather is available from Rank 5.", 3000);
                                return;
                            }
                            break;
                        ...
                        case "CarbineRifleMk2":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Force {selected} for MerryWeather is available from Rank 6.", 3000);
                                return;
                            }
                            break;
                        case "APPistol":
                        ...
                        case "BullpupRifle":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Force {selected} for MerryWeather is available from Rank 8.", 3000);
                                return;
                            }
                            break;
                        default:
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"You have crafted {selected} for {matsForGun[WeaponRepository.GetHash(selected)]} matov", 3000);
            }
            catch (Exception e)
            {
        ...
        public static void Event_WCraftAmmo(ExtPlayer player, int frac, int category, int ammo)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You have successfully crafted {Chars.Repository.ItemsInfo[AmmoTypes[category]].Name} x{ammo}", 3000);
            }
            catch (Exception e)
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    if (vehicleLocalData.Fraction == (int)Models.Fractions.ARMY)
                    {
                        ...
                        if (count >= 1)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Resources can only be unloaded to an army depot.", 3000);
                                return;
                            }
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "You have successfully unloaded resources into the warehouse.", 3000);

                            LoadInfo = LoadInfo.Remove(LoadInfo.Length - 2);
                            Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeOre, $"Unloaded at the army depot {LoadInfo}.");
                        }
                    }
                }
            }
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    switch (eventName)
                    {
                        case "loadmats":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You are not a member of {Manager.GetName(sessionData.OnFracStock)}", 3000);
                                return;
                            }
    ...
    class MatsWar : Script
    {
        ...
        public static void startWar()
        {
            ...
            {
                if (isWar) return;
                NAPI.Chat.SendChatMessageToAll("~o~[MATWAR] \"War for materials\" has been started!");
        ...
        public static void endWar()
        {
            try
            {
                NAPI.Task.Run(() =>
                {
                    try
                    {
                        NAPI.Chat.SendChatMessageToAll("~o~[MATWAR] \"War for materials\" was finished!");
