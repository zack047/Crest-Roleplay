    ...
    public class Repository
    {
        ...
        public static void UpdateRankScore(ExtPlayer player, int id, int score)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Minimum value {NeptuneEvo.Table.Repository.MinScore} maximum {NeptuneEvo.Table.Repository.MaxScore}", 4500);
                    return;
                }
        ...
        public static void DeletePlayer(ExtPlayer player, int uuid)
        {
            try
            {
                ...
                else
                {
                    ...
                    Logs.Repository.AddLogs(player, FractionLogsType.UnInvite, $"Retrieved {targetMemberFractionData.Name} ({targetMemberFractionData.UUID})");
