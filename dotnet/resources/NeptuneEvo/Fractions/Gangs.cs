...
namespace NeptuneEvo.Fractions
{
    class Gangs : Script
    {
        ...
        public void Event_OnResourceStart()
        {
            try
            {
                NAPI.TextLabel.CreateTextLabel("~g~Jackson Green", new Vector3(-222.5464, -1617.449, 35.86932), 5f, 0.3f, 0, new Color(255, 255, 255), true, 0);
                NAPI.TextLabel.CreateTextLabel("~g~Luke Miller", new Vector3(112.52232, -1961.4207, 19.94), 5f, 0.3f, 0, new Color(255, 255, 255), true, 0);
                NAPI.TextLabel.CreateTextLabel("~g~Wyatt Adamson", new Vector3(486.2756, -1528.2778, 30.28829), 5f, 0.3f, 0, new Color(255, 255, 255), true, 0);
                NAPI.TextLabel.CreateTextLabel("~g~Damian Morales", new Vector3(1435.6263, -1491.5796, 63.62193), 5f, 0.3f, 0, new Color(255, 255, 255), true, 0);
                NAPI.TextLabel.CreateTextLabel("~g~Simon Rodriguez", new Vector3(944.5905, -2161.819, 31.188383), 5f, 0.3f, 0, new Color(255, 255, 255), true, 0);
                ...
                foreach (Vector3 pos in DrugPoints)
                {
                    ...
                    Main.CreateBlip(new Main.BlipData(496, "Grass", pos, 25, true));
