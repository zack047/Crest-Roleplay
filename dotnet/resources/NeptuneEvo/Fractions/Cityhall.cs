...
{ 
    ...
    { 
        ...
        public static Vector3 CloakroomPosition = new Vector3(-572.35095, -198.34245, 38.219685); 
        public static Vector3 SecondCloakroomPosition = new Vector3(2522.4473f, -330.00107f, 94f); 
        private static Vector3 StockPosition = new Vector3(-567.40137, -196.09639, 38.21966); 
        public static Vector3 GiveGunPosition = new Vector3(-570.6762, -192.87108, 38.21966); 
        public static Vector3 SecondGiveGunPosition = new Vector3(2487.9102f, -376.6428f, 82.69f); 
        public static Vector3 GpsPosition = new Vector3(-550.4606, -196.89801, 38.219692f); 
        private static Vector3 CallingEmployeesPosition = new Vector3(-553.62616, -189.47148, 38.219654);
        ...
        private static Vector3 JobPosition2 = new Vector3(-547.72314, -188.81995, 38.219707); 
        ...
        { 
            try 
            { 
                Main.CreateBlip(new Main.BlipData(419, "Government", new Vector3(-545.02136, -204.28348, 38.2), 4, true)); 
                ...
                //Main.CreateBlip(new Main.BlipData(419, "Government", GpsPosition, 4, true, 1.5f)); 
                //Main.CreateBlip(new Main.BlipData(419, "Government", new Vector3(2515.921, -357.68134, 94), 4, true, 1.5f)); 
                Main.CreateBlip(new Main.BlipData(181, "Court", new Vector3(243.40225, -1073.7192, 29), 4, true)); 
                ...
                PedSystem.Repository.CreateQuest("s_m_y_devinsec_01", GiveGunPosition, -151.29482f, title: "~y~NPC~w~ Энтони Янг\nВыдача оружия", colShapeEnums: ColShapeEnums.FractionCityhallGunMenu);
                PedSystem.Repository.CreateQuest("s_m_y_devinsec_01", SecondGiveGunPosition, -151.29482f, title: "~y~NPC~w~ Джонни Ганз\nВыдача оружия", colShapeEnums: ColShapeEnums.FractionCityhallGunMenu); 
                ...
                PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition2, 152.57906f, title: "~y~NPC~w~ Эмма Смит\nУстройство на работу", colShapeEnums: ColShapeEnums.JobSelect); 
