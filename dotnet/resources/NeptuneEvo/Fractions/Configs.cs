...
namespace NeptuneEvo.Fractions
{
    class Configs : Script
    {
        ...
        public static void InitFractionDefaultRanksName()
        {
            ...
            if (fractionData.Ranks.Count == 0) fractions.Add(fractionId);
            AddFractionRanksData(fractionId, 1, "Security Guard", 0, 1, fractionData.RanksDefaultAccess[1]);
            AddFractionRanksData(fractionId, 2, "Handyman", 0, 2, fractionData.RanksDefaultAccess[2]);
            AddFractionRanksData(fractionId, 3, "Senior Security Guard", 0, 3, fractionData.RanksDefaultAccess[3]);
            AddFractionRanksData(fractionId, 4, "Crook", 0, 4, fractionData.RanksDefaultAccess[4]);
            AddFractionRanksData(fractionId, 5, "Schuler", 0, 5, fractionData.RanksDefaultAccess[5]);
            AddFractionRanksData(fractionId, 6, "Marsh", 0, 6, fractionData.RanksDefaultAccess[6]);
            AddFractionRanksData(fractionId, 7, "Authority", 0, 7, fractionData.RanksDefaultAccess[7]);
            AddFractionRanksData(fractionId, 8, "The Spectator", 0, 8, fractionData.RanksDefaultAccess[8]);
            AddFractionRanksData(fractionId, 9, "Polozhenetsky", 0, 9, fractionData.RanksDefaultAccess[9]);
            AddFractionRanksData(fractionId, 10, "The thief in the law", 0, 10, fractionData.RanksDefaultAccess[10]);
