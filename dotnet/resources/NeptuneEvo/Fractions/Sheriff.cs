...
{ 
    ...
    { 
        ...
        public static Vector3 FirstExitPrisonPosition = new Vector3(1851.0327, 2585.9954, 45.672016); 
        public static Vector3 SecondExitPrisonPosition = new Vector3(1851.0327, 2585.9954, 45.672016); 
        ...
        { 
            ...
            { 
                ...
                Ped ped = PedSystem.Repository.CreateQuest("s_f_y_sheriff_01", new Vector3(1852.9309, 3688.9907, 34.266937), -150.65309f, title: "~y~NPC~w~ Victoria Newton\nSecretary", colShapeEnums: ColShapeEnums.FracSheriff); 
                PedSecretaryId = ped.Value; 
                 
                Ped secondPed = PedSystem.Repository.CreateQuest("s_f_y_sheriff_01", new Vector3(-448.6393, 6012.3833, 31.7), -45.60703f, title: "~y~NPC~w~ Victoria Elise\nSecretary", colShapeEnums: ColShapeEnums.FracSheriff); 
                PedSecondSecretaryId = secondPed.Value; 
 
                PedSystem.Repository.CreateQuest("s_m_m_fibsec_01", FirstGunsPosition, -87.25532f, title: "~y~NPC~w~ Agent Alexander\nWarehouse", colShapeEnums: ColShapeEnums.FracSheriff); 
                PedSystem.Repository.CreateQuest("s_m_m_fibsec_01", SecondGunsPosition, 40.875225f, title: "~y~NPC~w~ Agent Rose\nWarehouse", colShapeEnums: ColShapeEnums.FracSheriff); 
                PedSystem.Repository.CreateQuest("s_m_m_armoured_02", new Vector3(-444.31284, 6010.7974, 31.716427), 47.103275f, title: "~y~NPC~w~ Sergeant Sobol\nTo call an employee", colShapeEnums: ColShapeEnums.CallSheriffMember);
            } 
            catch (Exception e) 
            { 
