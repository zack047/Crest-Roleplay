    ...
    class Army : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Click\n~r~'Interaction'"), new Vector3(ArmyCheckpoints[0].X, ArmyCheckpoints[0].Y, ArmyCheckpoints[0].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 3244522);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[1], 1, 2, 3244522, ColShapeEnums.FractionArmy, 1);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Click\n~r~'Interaction'"), new Vector3(ArmyCheckpoints[1].X, ArmyCheckpoints[1].Y, ArmyCheckpoints[1].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 3244522);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Elevator"), new Vector3(ArmyCheckpoints[3].X, ArmyCheckpoints[3].Y, ArmyCheckpoints[3].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[4], 1, 2, 0, ColShapeEnums.FractionArmy, 3);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Elevator"), new Vector3(ArmyCheckpoints[4].X, ArmyCheckpoints[4].Y, ArmyCheckpoints[4].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[5], 1, 2, 3244522, ColShapeEnums.FractionArmy, 4);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Open an armory"), new Vector3(ArmyCheckpoints[5].X, ArmyCheckpoints[5].Y, ArmyCheckpoints[5].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 3244522);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[6], 3, 3, 0, ColShapeEnums.FractionArmy, 5);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Repair of ground transport"), new Vector3(ArmyCheckpoints[6].X, ArmyCheckpoints[6].Y, ArmyCheckpoints[6].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[7], 5, 2, 0, ColShapeEnums.FractionArmy, 6);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Aircraft repair"), new Vector3(ArmyCheckpoints[7].X, ArmyCheckpoints[7].Y, ArmyCheckpoints[7].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[8], 1, 2, 0, ColShapeEnums.FractionArmy, 7);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~General alarm button"), new Vector3(ArmyCheckpoints[8].X, ArmyCheckpoints[8].Y, ArmyCheckpoints[8].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255), true);
                                
                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[9], 1, 2, 0, ColShapeEnums.FractionArmy, 8);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Click\n~r~'Interaction'"), new Vector3(ArmyCheckpoints[9].X, ArmyCheckpoints[9].Y, ArmyCheckpoints[9].Z), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[10], 1, 2, 3244522, ColShapeEnums.FractionArmy, 9);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Click\n~r~'Interaction'"), new Vector3(ArmyCheckpoints[10].X, ArmyCheckpoints[10].Y, ArmyCheckpoints[10].Z), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 3244522);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[11], 1, 2, 0, ColShapeEnums.FractionArmy, 10);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Click\n~r~'Interaction'"), new Vector3(ArmyCheckpoints[11].X, ArmyCheckpoints[11].Y, ArmyCheckpoints[11].Z), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[12], 1, 2, 4566544, ColShapeEnums.FractionArmy, 11);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Click\n~r~'Interaction'"), new Vector3(ArmyCheckpoints[12].X, ArmyCheckpoints[12].Y, ArmyCheckpoints[12].Z), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 4566544);
                ...
                PedSystem.Repository.CreateQuest("s_m_m_marine_01", new Vector3(-276.09488, -2636.1191, 6.0462055), -50.05095f, title: "~y~NPC~w~ Recruit Astrakhan\nTo call an employee", colShapeEnums: ColShapeEnums.CallArmyMember);
            }
        ...
        public static void OutFractionArmy(ExtPlayer player, int Index)
        {
            try
            {
                ...
                if (sessionData.TimersData.LoadMatsTimer != null)
                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Loading of materials is canceled because the vehicle left the checkpoint", 3000);
                }
            }
            catch (Exception e)
            {
