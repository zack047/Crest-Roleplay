            ...
            try
            {
                ...
                if (resultPoints != null && resultPoints.Rows.Count != 0)
                {
                    ...
                    if (ElectionPoint.Opened)
                    {
                        ...
                        ElectionPoint.Info = (ExtTextLabel) NAPI.TextLabel.CreateTextLabel($"Voting point\nVyborov №{ElectionPoint.Election}\n~w~Click\n~r~'Interaction'", new Vector3(ElectionPoint.Position.X, ElectionPoint.Position.Y, ElectionPoint.Position.Z + 1), 10f, 1f, 0, new Color(255, 255, 255), dimension: 0);
                    }
                }
