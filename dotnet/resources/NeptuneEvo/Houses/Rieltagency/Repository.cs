...
namespace NeptuneEvo.Houses.Rieltagency
{
    public class Repository
    {
        ...
        public static void OnResourceStart()
        {
            ...
            PedSystem.Repository.CreateQuest("a_m_y_business_02", new Vector3(-710.49, 267.8656, 83.14731), -92.04525f, title: "~y~NPC~w~ Ilon Tusk\nRealtor", colShapeEnums: ColShapeEnums.Rieltagency);
        }
        ...
        public static void OnBuy(ExtPlayer player, int id, int type)
        {
            ...
            EventSys.SendCoolMsg(player,"Realtor", "Buying information", $"{LangFunc.GetText(LangType.Ru, DataName.YouBoughtInfo)}", "", 15000);
