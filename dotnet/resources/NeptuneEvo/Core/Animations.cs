...
namespace NeptuneEvo.Core
{
    class Animations : Script
    {
        ...
        private static IReadOnlyDictionary<string, Animation> AnimList = new Dictionary<string, Animation>()
        {
            ...
            /* custom anims */
            {"6_89", new Animation("custom@dab", "dab", 39)},
            {"6_90", new Animation("custom@crossbounce", "crossbounce", 39)},
            {"6_91", new Animation("custom@dancemoves", "dancemoves", 39)},
            {"6_92", new Animation("custom@deskchan", "deskchan", 39)},
            {"6_93", new Animation("custom@disco_dance", "disco_dance", 39)},
            {"6_94", new Animation("custom@dont_start", "dont_start", 39)},
            {"6_95", new Animation("custom@dragonballz", "dragonballz", 39)},
            {"6_96", new Animation("custom@electroshuffle", "electroshuffle", 39)},
            {"6_97", new Animation("custom@electroshuffle_original", "electroshuffle_original", 39)},
            {"6_98", new Animation("custom@female_pose_1", "female_pose_1", 39)},
            {"6_99", new Animation("custom@female_pose_2", "female_pose_2", 39)},
            {"6_100", new Animation("custom@female_pose_3", "female_pose_3", 39)},
            {"6_101", new Animation("custom@floss", "floss", 39)},
            {"6_102", new Animation("custom@footwork", "footwork", 39)},
            {"6_103", new Animation("custom@fresh_fortnite", "fresh_fortnite", 39)},
            {"6_104", new Animation("custom@frightfunk", "frightfunk", 39)},
            {"6_105", new Animation("custom@gloss", "gloss", 39)},
            {"6_106", new Animation("custom@gylphic", "gylphic", 39)},
            {"6_107", new Animation("custom@headspin", "headspin", 39)},
            {"6_108", new Animation("custom@hiphop1", "hiphop1", 39)},
            {"6_109", new Animation("custom@hiphop2", "hiphop2", 39)},
            {"6_110", new Animation("custom@hiphop3", "hiphop3", 39)},
            {"6_111", new Animation("custom@hiphop90s", "hiphop90s", 39)},
            {"6_112", new Animation("custom@hiphop_pumpup", "hiphop_pumpup", 39)},
            {"6_113", new Animation("custom@hiphop_slide", "hiphop_slide", 39)},
            {"6_114", new Animation("custom@hiphop_yeah", "hiphop_yeah", 39)},
            {"6_115", new Animation("custom@hitit", "hitit", 39)},
            {"6_116", new Animation("custom@introducing", "introducing", 39)},
            {"6_117", new Animation("custom@in_da_party", "in_da_party", 39)},
            {"6_118", new Animation("custom@jumpingjack", "jumpingjack", 39)},
            {"6_119", new Animation("custom@last_forever", "last_forever", 39)},
            {"6_120", new Animation("custom@love", "love", 39)},
            {"6_121", new Animation("custom@male_pose_1", "male_pose_1", 39)},
            {"6_122", new Animation("custom@male_pose_2", "male_pose_2", 39)},
            {"6_123", new Animation("custom@male_pose_3", "male_pose_3", 39)},
            {"6_124", new Animation("custom@narutorun", "narutorun", 39)},
            {"6_125", new Animation("custom@orangejustice", "orangejustice", 39)},
            {"6_126", new Animation("custom@pluck_fruits", "pluck_fruits", 39)},
            {"6_127", new Animation("custom@popcorneat", "popcorneat", 39)},
            {"6_128", new Animation("custom@renegade", "renegade", 39)},
            {"6_129", new Animation("custom@rickrool", "rickroll", 39)},
            {"6_130", new Animation("custom@robotdance_fortnite", "robotdance_fortnite", 39)},
            {"6_131", new Animation("custom@salsatime", "salsatime", 39)},
            {"6_132", new Animation("custom@samba", "samba", 39)},
            {"6_133", new Animation("custom@savage", "savage", 39)},
            {"6_134", new Animation("custom@sayso", "sayso", 39)},
            {"6_135", new Animation("custom@sheeeeesh", "sheeeeesh", 39)},
            {"6_136", new Animation("custom@shockdance", "shockdance", 39)},
            {"6_137", new Animation("custom@smooth_moves", "smooth_moves", 39)},
            {"6_138", new Animation("custom@specialdance", "specialdance", 39)},
            {"6_139", new Animation("custom@take_l", "take_l", 39)},
            {"6_140", new Animation("custom@toetwist", "toetwist", 39)},
            {"6_141", new Animation("custom@toosie_slide", "toosie_slide", 39)},
            {"6_142", new Animation("custom@waiter", "waiter", 39)},
            {"6_143", new Animation("mikey@gangsigns@new", "new", 39)},
