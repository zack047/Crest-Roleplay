...
namespace NeptuneEvo.Players.Phone.Gps
{
    public class Repository
    {
        ...
        public static void Init()
        {
            ...
            recentCategory.Name = "Recent Places";
            ...
            recentCategory.Items.Add(new GpsItem("Nearest ATM", posList));
            ...
            for (byte i = 0; i != BusinessManager.BusinessTypeNames.Length; i++)
            {
                ...
                if (posList.Count > 0)
                    recentCategory.Items.Add(new GpsItem($"Nearest '{BusinessManager.BusinessTypeNames[i]}'", posList));
            }
            ...
            recentCategory.Items.Add(new GpsItem("Nearest stop", posList));
            ...
            recentCategory.Items.Add(new GpsItem("Nearest Motorycle Rental", posList));
            ...
            */
            ...
            recentCategory.Items.Add(new GpsItem("Nearest boat rental", posList));
            ...
            funCategory.Name = "Entertainment";
            funCategory.Icon = "smiles";
            funCategory.Items = new List<GpsItem>();
            
            
            funCategory.Items.Add(new GpsItem("Casino", 936.0022f, 47.08651f));
            ...
            funCategory.Items.Add(new GpsItem("Starter Quests", -480.28732f, -305.2201f));
           // funCategory.Items.Add(new GpsItem("Клуб Diamond", 945.4526f, 16.871f));
            ...
            funCategory.Items.Add(new GpsItem("Beach Party", -1497.7688f, -1484.525f));
            funCategory.Items.Add(new GpsItem("Beach Party", -1705.88f, -970.7998f));
            funCategory.Items.Add(new GpsItem("Island", 1268.207f, -3325.8962f));
            funCategory.Items.Add(new GpsItem("Stand Up Cafe",  -439.601f, 271.704f));
            funCategory.Items.Add(new GpsItem("Chinese Restaurant", -158.242f, 303.829f));
            ...
            gosCategory.Name = "Government Buildings";
            ...
            licensesCategory.Name = "Licenses";
            licensesCategory.Icon = "licenses";
            licensesCategory.Items = new List<GpsItem>();

            licensesCategory.Items.Add(new GpsItem("Employment Center", 418.70874f, -624.9391f));
            licensesCategory.Items.Add(new GpsItem("Power Station", 724.9625f, 133.9959f));
            licensesCategory.Items.Add(new GpsItem("Post Office", 133.0764f, 96.67652f));
            licensesCategory.Items.Add(new GpsItem("Lawn Mower Parking", -1330.482f, 42.12986f));
            ...
            jobsCategory.Name = "Jobs";
            jobsCategory.Icon = "jobs";
            jobsCategory.Items = new List<GpsItem>();

            jobsCategory.Items.Add(new GpsItem("Mining", 1887.7855f, 3266.2427f));
            //jobsCategory.Items.Add(new GpsItem("Государственная шахта", -596, 2089));
            jobsCategory.Items.Add(new GpsItem("Lumberjack ", -459.95f, -1154.8129f));
            ...
            clubsCategory.Name = "Other";
            clubsCategory.Icon = "clubs";
            clubsCategory.Items = new List<GpsItem>();
            
            clubsCategory.Items.Add(new GpsItem("Postal Office", 133.16599f, 96.30163f));
            clubsCategory.Items.Add(new GpsItem("Obtaining a license", 435.8382f, -984.11847f));
            clubsCategory.Items.Add(new GpsItem("Families", -773.8519f, 312.5361f));
            clubsCategory.Items.Add(new GpsItem("Fireworks", -602.0729f, -347.30234f));
            ...
            clubsCategory.Items.Add(new GpsItem("Lighthouse", 3320.067f, 5169.669f));
            clubsCategory.Items.Add(new GpsItem("Hunting Shop", -827.79517f, -689.95886f));
            clubsCategory.Items.Add(new GpsItem("Main Market", Inventory.Tent.Models.TentList.PositionGps[0].X, Inventory.Tent.Models.TentList.PositionGps[0].Y));
            clubsCategory.Items.Add(new GpsItem("Black Market", Inventory.Tent.Models.TentList.PositionGps[1].X, Inventory.Tent.Models.TentList.PositionGps[1].Y));
            clubsCategory.Items.Add(new GpsItem("Church", -779.12885f, -709.137f));
            clubsCategory.Items.Add(new GpsItem("Pet Seller", 268.109f, -641.3529f));
            clubsCategory.Items.Add(new GpsItem("Court", 243.40225f, -1073.7192f));
            clubsCategory.Items.Add(new GpsItem("Real Estate Agency", -710.49f, 267.8656f));
            clubsCategory.Items.Add(new GpsItem("Furniture Store", Houses.FurnitureManager.FurnitureBuyPos.X, Houses.FurnitureManager.FurnitureBuyPos.Y));
            clubsCategory.Items.Add(new GpsItem("Inpound Lot", Fractions.Ticket.PedPos.X, Fractions.Ticket.PedPos.Y));
