...
namespace NeptuneEvo.MoneySystem
{
    class Casino : Script
    {
        ...
        // moved this to C:\Grandlegacy\dotnet\resources\NeptuneEvo\Core\Blips.cs
        ...
        public static Vector3[] casinoChecks = new Vector3[7]
                {
            new Vector3(936.0022, 47.08651, 81.09579), // Маркер входа с улицы в казино
        ...
        public static void OnResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Click\n~r~'Interact'"), new Vector3(casinoChecks[0].X, casinoChecks[0].Y, casinoChecks[0].Z), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Click\n~r~'Interact'"), new Vector3(casinoChecks[1].X, casinoChecks[1].Y, casinoChecks[1].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
               ...
               /* CustomColShape.CreateCylinderColShape(casinoChecks[3], 1, 2, 0, ColShapeEnums.Casino, 4);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Klick\n~r~'Interaktion'"), new Vector3(casinoChecks[3].X, casinoChecks[3].Y, casinoChecks[3].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Klick\n~r~'Interaktion'"), new Vector3(casinoChecks[4].X, casinoChecks[4].Y, casinoChecks[4].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Klick\n~r~'Interaktion'"), new Vector3(casinoChecks[5].X, casinoChecks[5].Y, casinoChecks[5].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Klick\n~r~'Interaktion'"), new Vector3(casinoChecks[6].X, casinoChecks[6].Y, casinoChecks[6].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                NAPI.Marker.CreateMarker(21, casinoChecks[6] + new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.8f, new Color(255, 255, 255, 60));*/

                // moved this to C:\Grandlegacy\dotnet\resources\NeptuneEvo\Core\Blips.cs
                //Main.CreateBlip(new Main.BlipData(681, "Casino", blipPosition, 18, true));
            }
            catch (Exception e)
            {
