    ...
    class ATM : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                {
                    if (i != 58) Main.CreateBlip(new Main.BlipData(500, "ATM", ATMs[i], 7, true, 0.32f));
                ...
                switch (type)
                {
                    ...
                    case 2:
                        ...
                        switch (accountData.VipLvl)
                        {
                            case 0:
                            case 1:
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(house.Price / 100 * 0.026 * 24 * 7)}$','Cash deposit amount']");
                                break;
                            case 2:
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(house.Price / 100 * 0.026 * 24 * 14)}$','Cash deposit amount']");
                                break;
                            case 3:
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(house.Price / 100 * 0.026 * 24 * 21)}$','Cash deposit amount']");
                                break;
                            case 4: // Platinum
                            case 5: // Media Platinum
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(house.Price / 100 * 0.026 * 24 * 28)}$','Cash deposit amount']");
                                break;
                            default:
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(house.Price / 100 * 0.026 * 24 * 7)}$','Cash deposit amount']");
                                break;
                    ...
                    case 3:
                        ...
                        switch (accountData.VipLvl)
                        {
                            case 0:
                            case 1:
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 7)}$','Credit amount']");
                                break;
                            case 2:
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 14)}$','Credit amount']");
                                break;
                            case 3:
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 21)}$','Credit amount']");
                                break;
                            case 4: // Platinum
                            case 5: // Media Platinum
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 28)}$','Credit amount']");
                                break;
                            default:
                                Trigger.ClientEvent(player, "atmOpen", $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 7)}$','Credit amount']");
                                break;
                    ...
                    case 4:
                        ...
                        Trigger.ClientEvent(player, "atmOpen", "[2,0,'Amount to be transferred']");
            ...
            try
            {
                ...
                switch (type)
                {
                    case 1:
                        ...
                        {
                            case 0:
                                Trigger.ClientEvent(player, "atmOpen", "[2,' ','Cash deposit amount']");
                                sessionData.ATMData.Type = index;
                                break;
                            case 1:
                                Trigger.ClientEvent(player, "atmOpen", "[2,' ','Amount to withdraw']");
                                sessionData.ATMData.Type = index;
                                break;
                            case 2:
                                ...
                                Trigger.ClientEvent(player, "setatm", LangFunc.GetText(LangType.Ru, DataName.House), $"Real Estate #{house.ID}", bankBalance, "");
                                sessionData.ATMData.Type = index;
                                break;
                            case 3:
                                AtmBizGen(player);
                                ...
                                break;
                            case 4:
                                Trigger.ClientEvent(player, "atmOpen", "[2,0,'Enrollment account']");
                                sessionData.ATMData.Type = index;
                                break;
                            default:
                                // Not supposed to end up here. 
                        ...
                        switch (accountData.VipLvl)
                        {
                            ...
                            case 1:
                                Trigger.ClientEvent(player, "atmOpen",
                                    $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 7)}$','Credit amount']");
                                break;
                            case 2:
                                Trigger.ClientEvent(player, "atmOpen",
                                    $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 14)}$','Credit amount']");
                                break;
                            case 3:
                                Trigger.ClientEvent(player, "atmOpen",
                                    $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 21)}$','Credit amount']");
                                break;
                            case 4: // Platinum
                            case 5: // Media Platinum
                                Trigger.ClientEvent(player, "atmOpen",
                                    $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 28)}$','Credit amount']");
                                break;
                            default:
                                Trigger.ClientEvent(player, "atmOpen",
                                    $"[2,'{bankBalance}/{Convert.ToInt32(biz.SellPrice / 100 * biz.Tax * 24 * 7)}$','Credit amount']");
