    ...
    public class Repository
    {
        ...
        public static void VerificationConfirm(string hash, string ga)
        {
            ...
            if (emailVerification != null)
            {
                ...
                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge, $"The mail is confirmed successfully.The prize was sent to the warehouse.(M-> GPS -> Warehouse)", DateTime.Now);
