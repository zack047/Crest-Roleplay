    ...
    class Chat : Script
    {
        ...
        public void API_onChatMessage(ExtPlayer player, string message)
        {
            try
            {
                ...
                // Define name here
                string name = characterData.FirstName + " " + characterData.LastName;
                ...
                string text = $"[{characterData.UUID}] {name}: " + message;
                ...
                if (characterData.AdminLVL > 0 && adminConfig.RedName)
                    text = $"Administrator {name}: " + message;
                ...
                if (phoneMeta.CallingState == "talk")
                {
                    ...
                    Trigger.SendChatMessage(target, $"[On the Phone] {contactName}: {message}");
