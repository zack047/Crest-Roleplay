            ...
            switch ((data_quests)Line)
            {
                case data_quests.Start:
                    ...
                    if (Chars.Repository.isItem(player, "inventory", ItemId.Hammer) == null && Chars.Repository.isItem(player, "inventory", ItemId.Wrench) == null)
                    {
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "The nearest 24/7 was marked on the map.", 3000);
                    }
                    break;
                case data_quests.Tools:
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "Fix the boat!", 3000);
                    break;
                default:
                    // Not supposed to end up here. 
                    break;
