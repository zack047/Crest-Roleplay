        ...
        public void take_quest_item(ExtPlayer player, int index)
        {
            ...
            Timers.StartOnce(5000, () =>
            {
                try
                {
                    ...
                    if (index >= 2)
                    {
                        Trigger.SendChatMessage(player, "You have collected all the Bears, give them to Granny Granny!");
                    }
                    else if (index == 1)
                    {
                        Trigger.SendChatMessage(player, "You have collected 1/2 of the Bears. The last Bear is left. The map shows the approximate location of the last Bear as follows!");
                    }
