...
namespace NeptuneEvo.Quests
{
    class Wedding : Script
    {
        ...
        {
            Main.CreateBlip(new Main.BlipData(622, "Church", new Vector3(-759.22766, -709.2103, 30.061632), 59, true));
            PedSystem.Repository.CreateQuest("cs_priest", new Vector3(-786.86f, -708.91, 30.322592), -94f, title: "~y~NPC~w~ Father Michael\nPriest", colShapeEnums: ColShapeEnums.QuestWedding);
        }
