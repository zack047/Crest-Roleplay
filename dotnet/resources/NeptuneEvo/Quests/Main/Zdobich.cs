...
{    
    ...
    public class Zdobich : Script
    {
        ...
        {
            PedSystem.Repository.CreateQuest("u_m_y_antonb", new Vector3(-480.28732, -305.2201, 35.106697), -157f, questName: QuestName, title: "~y~NPC~w~ Vitaly Dobich\nBeginner Quests", colShapeEnums: ColShapeEnums.QuestZdobich);
