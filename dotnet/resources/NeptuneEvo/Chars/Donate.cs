...
namespace NeptuneEvo.Chars
{
    class Donate : Script
    {
        ...
        {
            new List<object>{500000, "$", "Plain"},//0
            new List<object>{5000, "RB", "Rare"},//1
            new List<object>{7000, "RB", "Unique"},//2
            new List<object>{10000, "RB", "Unique"},//3
            new List<object>{15000, "RB", "Suite"},//4
            new List<object>{35000, "RB", "Suite"}//5
            
        };
        public static int GetVehicleNumberPrice(string number)
        {
            object[] test = {30000, "RB", "Suite"};
        ...
        public void BuyVehNumber(ExtPlayer player, string number)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "The number already exists", 3000);
                return;
            }
        ...
        {
            new List<object>{55000, "RB", "Suite"},//0
            new List<object>{45000, "RB", "Suite"},//1
            new List<object>{35000, "RB", "Suite"},//2
            new List<object>{25000, "RB", "Rare"},//3
            new List<object>{20000, "RB", "Rare"},//4
            new List<object>{15000, "RB", "Unique"},//5
            new List<object>{10000, "RB", "Unique"},//6
            new List<object>{7500, "RB", "Unique"},//7
            new List<object>{5000, "RB", "Plain"},//8
        ...
        public void BuyVehNumber(ExtPlayer player, int sim)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Incorrect number format", 3000);
                return;
            }
