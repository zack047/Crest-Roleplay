...
namespace NeptuneEvo.Chars
{
    ...
    class Repository : Script
    {
        ...
        public static RouletteCategory[] RoulleteCategoryList =
        {
            ...
            new RouletteCategory("Standard", "kesys_5", new int[] {3, 4, 5, 6, 7}),
        ...
        public static List<RouletteCaseData> RouletteCasesData = new List<RouletteCaseData> { 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case0, "Free daily case", 0, new List<RouletteItemData>(), "keys_0", "Бесплатный кейс, можно открыть спустя 3 часа игры."), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case1, "Free gun case", 0, new List<RouletteItemData>(), "keys_1", "Бесплатный кейс с оружием, можно открыть спустя 5 часов игры."), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case2, "Free Car Case", 0, new List<RouletteItemData>(), "keys_2", "Бесплатный кейс с машинами, можно открыть спустя 8 часов игры."), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case3, "Standard case", 99, new List<RouletteItemData>(), "keys_3", "Стандартный кейс со стандартными призами."),             
            /* 
            Case 'VIP' - 19 items 
            Blue    40.00% 
            Yellow  14.80% 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case4, "Weird case", 249, new List<RouletteItemData>(), "keys_4", "Неплохой кейс для начинающих."), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case5, "Special case", 499, new List<RouletteItemData>(), "keys_5", "Сочный кейс, есть возможность серьёзно окупиться!"), 
            /* 
            Case 'Rare' - 15 items 
            Blue    29.00% 
            Yellow  40.00% 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case6, "Rare case", 999, new List<RouletteItemData>(), "keys_6", "Кейс с вещами и автомобилями повышенной редкости."), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case7, "The case of the fierce", 2499, new List<RouletteItemData>(), "keys_7", "Очень лютый кейс. Суперприз - Bugatti, самый быстрый автомобиль."), 
                        /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case8, "Men's briefcase", 2999, new List<RouletteItemData>(), "keys_9", "Кейс с МУЖСКОЙ одеждой из донатного магазина одежды. Испытай удачу и будь стильным, или продай кому-то и будь богатым. А можешь и подарить..."), 
                        /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case9, "Women's case", 2999, new List<RouletteItemData>(), "keys_10", "Кейс с ЖЕНСКОЙ одеждой из донатного магазина одежды. Отличный вариант, если хочется что-нибудь подарить."), 
                        /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case10, "Exotic case", 7777, new List<RouletteItemData>(), "keys_8", "Кейс с автомобилями из DonateRoom Autoroom. Доната Редбаксовна одобряет!"),
            new RouletteCaseData(ItemId.Case11, "Legendary case", 5555, new List<RouletteItemData>(), "keys_11", "Все или ничего! Хочешь рискнуть и стать обладателем легендарной кофты RedAge? Тогда крути кейс!"),
            new RouletteCaseData(ItemId.Case12, "Interesting Case", 3999, new List<RouletteItemData>(), "keys_12", "Давно хочешь себе уникальную машину которая нигде не продается? Пожалуйста! Dodge Charger - стоит на вооружении у полиции, обладает довольно высокими характеристиками."),
            new RouletteCaseData(ItemId.Case13, "Helicopter Case", 8888, new List<RouletteItemData>(), "keys_13", "Любишь смотреть на людей свысока? Пожалуй, для этого идеально подойдет вертолёт!"),
            new RouletteCaseData(ItemId.Case14, "Armored Case", 5000, new List<RouletteItemData>(), "keys_14", "Классный новый кейс с модными бронированными тачками!"),
            new RouletteCaseData(ItemId.Case15, "Exclusive Case", 100, new List<RouletteItemData>(), "keys_15", "Классный новый с размещаемыми предметами!"),
            new RouletteCaseData(ItemId.Case16, "Snowy Case [М]", 5000, new List<RouletteItemData>(), "keys_16", "Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. Насколько быстро ты сможешь собрать свой сет?"),
            new RouletteCaseData(ItemId.Case17, "Amethyst Case [М]", 5000, new List<RouletteItemData>(), "keys_17", "Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. Насколько быстро ты сможешь собрать свой сет?"),
            new RouletteCaseData(ItemId.Case18, "Holiday Case [М]", 5000, new List<RouletteItemData>(), "keys_18", "Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. Насколько быстро ты сможешь собрать свой сет?"),
            new RouletteCaseData(ItemId.Case19, "Snowy Case [Ж]", 5000, new List<RouletteItemData>(), "keys_19", "Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. Насколько быстро ты сможешь собрать свой сет?"),
            new RouletteCaseData(ItemId.Case20, "Amethyst Case [Ж]", 5000, new List<RouletteItemData>(), "keys_20", "Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. Насколько быстро ты сможешь собрать свой сет?"),
            new RouletteCaseData(ItemId.Case21, "Holiday Case [Ж]", 5000, new List<RouletteItemData>(), "keys_21", "Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. Насколько быстро ты сможешь собрать свой сет?"),
        };
        ...
        private static void RouletteWinAnnounce(ExtPlayer player, int caseid, RouletteItemData RouletteItem, int amount, bool type, byte bonuscase)
        {
            try
            {
                ...
                if (RouletteItem.IsChatMessage)
                {
                    ...
                    {
                        case "Игровая валюта":
                            NAPI.Chat.SendChatMessageToAll($"~g~[PRIZE FROM THE CASE] Yay! {player.Name} gets an extremely rare prize - {Wallet.Format(amount)} {RouletteItem.Name} From {RouletteCasesData[caseid].Name}!");
                            break;
                        case "RedBucks":
                            NAPI.Chat.SendChatMessageToAll($"~g~[PRIZE FROM THE CASE] Wow! The Pocket {player.Name} was replenished with crispy redbucks to the amount of {Wallet.Format(amount)} {RouletteItem.Name}! It's all because {RouletteCasesData[caseid].Name}!");
                            break;
                        default:
                            NAPI.Chat.SendChatMessageToAll($"~g~[PRIZE FROM THE CASE] Unbelievable! {player.Name} gets a rare prize - {RouletteItem.Name} From {RouletteCasesData[caseid].Name}!");
                            break;
                    }
                }
                if (RouletteItem.IsHudMessage)
                {
                    ...
                    {
                        case "Игровая валюта":
                            SupperWin($"{Wallet.Format(amount)} RedBucks of {RouletteCasesData[caseid].Name}!", RouletteItem.Name, RouletteItem.Image, player.Name);
                            break;
                        case "RedBucks":
                            SupperWin($"{Wallet.Format(amount)} RedBucks of {RouletteCasesData[caseid].Name}!", RouletteItem.Name, RouletteItem.Image, player.Name);// NE SMOG
                            break;
                        default:
                            SupperWin($"{RouletteItem.Name} From {RouletteCasesData[caseid].Name}!", RouletteItem.Name, RouletteItem.Image, player.Name);
                            break;
                    }
                }
        ...
        {
            new RefferalData("Time to start?", 0, 0, 0, true, 200, 5), // Первый, нулевой человек
            new RefferalData("First Steps", 1, 4, 1, true, 250, 7), // 1 - 4 человек
            new RefferalData("Beginner", 5, 4, 1, true, 300, 10), // 5 - 9
            new RefferalData("Minivaner", 10, 4, 1, true, 375, 13), // 10 - 14
            new RefferalData("Kapturshchik junior", 15, 4, 1, true, 400, 15), // 15 - 19
            new RefferalData("Meat Carrier", 20, 4, 1, true, 425, 17), // 20 - 29
            new RefferalData("Wild kite", 30, 4, 1, true, 500, 20), // 30 - 39
            new RefferalData("Combat unit", 40, 4, 1, true, 550, 22), // 40 - 49
            new RefferalData("Vasily the Mafioso", 50, 4, 1, true, 600, 25), // 50 - 60
            new RefferalData("The ripe merchant", 60, 4, 1, true, 625, 27), // 60 - 70
            new RefferalData("Vladimir II", 70, 4, 1, true, 700, 30), // 70 - 89
            new RefferalData("Fame", 80, 4, 1, true, 750, 32), // 80 - 99
            new RefferalData("CEO", 100, 4, 1, true, 800, 35), // 100 - 119
            new RefferalData("Generalissimo", 120, 4, 1, true, 850, 37), // 120 - 149
            new RefferalData("Vice-El Presidente", 150, 4, 2, true, 900, 40), // 150 - 200
            new RefferalData("El Presidente", 200, 4, 3, true, 1000, 50), // 201+
        };
        #endregion
        ...
        public static void ChangeAutoNumberInit()
        {
            ...
            PedSystem.Repository.CreateQuest("s_m_m_fiboffice_02", new Vector3(-1288.142, -579.7515, 30.573048), 27.65183f, title: "~y~NPC~w~ Edward Daniels\nChange of rooms", colShapeEnums: ColShapeEnums.ChangeAutoNumber);
        ...
        public static void OnChangeAutoNumber(ExtPlayer player)
        {
            try
            {
                ...
                frameList.Header = "Choice of machine";
        ...
        private static void CallbackChangeAutoNumber(ExtPlayer player, object listItem)
        {
            try
            {
                ...
                else
                {
                    ...
                    Trigger.ClientEvent(player, "openDialog", "ChangeAutoNumberConfirm", $"Are you sure you want to swap license plates {vehicleData1.Model} of {vehicleData2.Model}?<br/><br/>The cost of the exchange is $70,000");
                }
            }
            catch (Exception e)
            {
 ...
 */
        ...
        public static IReadOnlyDictionary<ItemId, ItemsInfo> ItemsInfo = new Dictionary<ItemId, ItemsInfo>()
        {
            ...
            { ItemId.Bag, new ItemsInfo("Bag", "Позволяет переносить в себе любые предметы.", "inv-item-backpack", "Одежда", NAPI.Util.GetHashKey("prop_cs_heist_bag_02"), 1, new Vector3(0, 0, -0.85), new Vector3(), newItemType.Clothes) },
            ...
            { ItemId.GasCan, new ItemsInfo("Canister", "Можно заправить транспортное средство.","inv-item-gasoline", "Инструменты", 786272259, 2, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.None) },
            { ItemId.Crisps, new ItemsInfo("Chips", "Закуска, восстанавливает 30% здоровья.","inv-item-Chips", "Еда", 2564432314, 4, new Vector3(0.0,0.0,-1.0), new Vector3(90, 90, 0), newItemType.Eat) },
            { ItemId.Beer, new ItemsInfo("Beer", "Пивка для рывка!","inv-item-beer", "Вода", 1940235411, 5, new Vector3(0.0,0.0,-0.97), new Vector3(-80, 0, 0), newItemType.Water) },
            { ItemId.Pizza, new ItemsInfo("Pizza", "Ммм... Пицца... Восстанавливает 30% здоровья.","inv-item-pizza", "Еда", 604847691, 3, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Eat) },
            { ItemId.Burger, new ItemsInfo("Burger", "Булка с котлеткой, восстанавливает 30% здоровья.","inv-item-burger", "Еда", 2240524752, 4, new Vector3(0.0,0.0,-0.97), new Vector3(), newItemType.Eat) },
            { ItemId.HotDog, new ItemsInfo("Hot-Doг", "Булка с сосиской, восстанавливает 30% здоровья.","inv-item-hot-dog", "Еда", 2565741261, 5, new Vector3(0.0,0.0,-0.97), new Vector3(), newItemType.Eat) },
            { ItemId.Sandwich, new ItemsInfo("Sandwich", "Несколько ломтиков хлеба и мяса, восстанавливает 30% здоровья.","inv-item-sandwich", "Еда", 987331897, 7, new Vector3(0.0,0.0,-0.99), new Vector3(), newItemType.Eat) },
            ...
            { ItemId.KeyRing, new ItemsInfo("A bunch of keys", "Собирает все ключи в одну большую связку и экономит место в карманах!","inv-item-key-2", "Инструмент", 977923025, 1, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.None) },
            /* Drinks */
            ...
            { ItemId.Hammer, new ItemsInfo("Hammer", "Молоток поможет вам в домашних делах.","inv-item-Hammer", "Оружие ближнего боя", 64104227, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            ...
            { ItemId.Crowbar, new ItemsInfo("Scrap", "Лом один из самых популярных инструментов.","inv-item-crowbar", "Оружие ближнего боя", 1862268168, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            ...
            { ItemId.Flashlight, new ItemsInfo("Flashlight", "Яркий свет, поможет вам если вы потерялись в темном лесу.","inv-item-Flashlight", "Оружие ближнего боя", 2278481040, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            ...
            { ItemId.Ball, new ItemsInfo("Ball", "Для игр с питомцем","inv-item-ball", "Особое", 1297482736, 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Weapons) },
            ...
            { ItemId.Bear, new ItemsInfo("Bear", "Подари приятному человеку!","inv-item-teddy-bear", "Особое", NAPI.Util.GetHashKey("v_ilev_mr_rasberryclean"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Note, new ItemsInfo("Note", "С помощью записки можно оставить послание, передать какой-то секрет или другую важную информацию.","inv-item-Note", "Особое", NAPI.Util.GetHashKey("p_amanda_note_01_s"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.LoveNote, new ItemsInfo("Love letter", "Валентинка поможет описать свои теплые чувства к человеку.","inv-item-LoveNote", "Особое", NAPI.Util.GetHashKey("p_amanda_note_01_s"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Vape, new ItemsInfo("Vape", "Напас сочного вейпика всегда поднимает настроение.","inv-item-Vape", "Особое", NAPI.Util.GetHashKey("ba_prop_battle_vape_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Rose, new ItemsInfo("Rose", "Прекрасный подарок для любимого человека!","inv-item-rose", "Особое", NAPI.Util.GetHashKey("prop_single_rose"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Barbell, new ItemsInfo("Barbell", "Для желающих подравнять свою эстетику.","inv-item-barbell", "Особое", NAPI.Util.GetHashKey("prop_barbell_02"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Binoculars, new ItemsInfo("Binoculars", "Позволяет видеть обьекты на дальнем расстоянии.","inv-item-binoculars", "Особое", NAPI.Util.GetHashKey("prop_binoc_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Bong, new ItemsInfo("Bong", "Удобная штучка для употребления травки.","inv-item-bong", "Особое", NAPI.Util.GetHashKey("prop_bong_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Umbrella, new ItemsInfo("Umbrella", "Позволит укрыться от дождя и придаст стиля.","inv-item-umbrella", "Особое", NAPI.Util.GetHashKey("p_amb_brolly_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Camera, new ItemsInfo("Camera", "Свет... Камера... Мотор!","inv-item-camera", "Особое", NAPI.Util.GetHashKey("prop_v_cam_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Microphone, new ItemsInfo("Microphone", "Предмет настоящего оратора.","inv-item-microphone", "Особое", NAPI.Util.GetHashKey("p_ing_microphonel_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Guitar, new ItemsInfo("Guitar", "Так и просится в руки... Сыграй что-нибудь!","inv-item-guitar", "Особое", NAPI.Util.GetHashKey("prop_acc_guitar_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            ...
            { ItemId.Radio, new ItemsInfo("The radio", "С помощью рации можно общаться с другими обладателями рации, или даже подслушать полицейскую или другую секретную волну.", "hud__icon-walkie-talkie", "Особое", NAPI.Util.GetHashKey("prop_cs_hand_radio"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            ...
            { ItemId.Hookah, new ItemsInfo("Hookah", "Калюмбас для лютого распыха! Двойное яблочко и полетели...", "inv-item-hookah", "Особое", NAPI.Util.GetHashKey("hookah_model"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
        ...
        public static string getCountToStockItems(string locationName)
        {
            try
            {
                ...
                return $"Weapons: {otherCount} piece. | Ammo: {ammoCount} piece.";
            }
            catch (Exception e)
            {
                Log.Write($"getCountToStockItems Exception: {e.ToString()}");
                return $"Weapons: 0 piece. | Ammo: 0 piece.";
            }
        }
        ...
        public static void ItemsUse(ExtPlayer player, string ArrayName, int Index, bool fastSlotsToggled = true)
        {
            try
            {
                ...
                if (ItemInfo.functionType == newItemType.Clothes/* && Item.ItemId != ItemId.BodyArmor && Item.ItemId != ItemId.Mask*/)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "It is impossible to put on a bulletproof vest while in a vehicle.", 3000);
                        return;
                    }
                ...
                else if (ItemInfo.functionType == newItemType.Alco)
                {
                    ...
                    Commands.RPChat("sme", player, $"beverage" + (characterData.Gender ? "" : "а") + $" bottle {Name}");
                    GameLog.Items($"usedItem({Item.SqlId})", $"char_{characterData.UUID}", Convert.ToInt32(Item.ItemId), 1, Item.Data);
                    success = true;
                }
                ...
                switch (Item.ItemId)
                {
                    ...
                    case ItemId.Burger:
                        if (DateTime.Now > sessionData.TimingsData.NextEat)
                        {
                            ...
                            //Commands.RPChat("sme", player, $"ate" + (characterData.Gender ? "" : "а") + $" {ItemInfo.Name}");
                    ...
                    case ItemId.Drugs:
                        if (DateTime.Now > sessionData.TimingsData.NextDrugs)
                        {
                            ...
                            {
                                case 0:
                                    Commands.RPChat("sme", player, $"up in smoke" + (characterData.Gender ? "" : "а") + " among");
                                    break;
                                case 1:
                                    Commands.RPChat("sme", player, $"smacked" + (characterData.Gender ? "" : "а") + " bun");
                                    break;
                                case 2:
                                    Commands.RPChat("sme", player, $"boiled" + (characterData.Gender ? "" : "а") + " plushie");
                                    break;
                                case 3:
                                    Commands.RPChat("sme", player, $"smoked" + (characterData.Gender ? "" : "а") + " joint");
                                    break;
                                case 4:
                                    Commands.RPChat("sme", player, $"made" + (characterData.Gender ? "" : "а") + " grab bag");
                                    break;
                                case 5:
                                    Commands.RPChat("sme", player, $"blew" + (characterData.Gender ? "" : "а") + " tube");
                                    break;
                                case 6:
                                    Commands.RPChat("sme", player, $"dragged" + (characterData.Gender ? "" : "а") + " dope");
                                    break;
                                case 7:
                                    Commands.RPChat("sme", player, $"blew up" + (characterData.Gender ? "" : "а") + " rocket");
                                    break;
                                case 8:
                                    Commands.RPChat("sme", player, $"grabbed" + (characterData.Gender ? "" : "а") + " Schmaltz");
                                    break;
                                default:
                                    Commands.RPChat("sme", player, $"smoked" + (characterData.Gender ? "" : "а") + " jamb");
                                    break;
                            }
                    ...
                    case ItemId.Cocaine:
                        if (DateTime.Now > sessionData.TimingsData.NextDrugs)
                        {
                            ...
                            {
                                case 0:
                                    Commands.RPChat("sme", player, $"sniffed" + (characterData.Gender ? "" : "а") + " path");
                                    break;
                                case 1:
                                    Commands.RPChat("sme", player, $"Smacked" + (characterData.Gender ? "" : "а") + " path");
                                    break;
                                case 2:
                                    Commands.RPChat("sme", player, $"sucked in with his nose." + (characterData.Gender ? "" : "а") + " path");
                                    break;
                                case 3:
                                    Commands.RPChat("sme", player, $"sniffed" + (characterData.Gender ? "" : "а") + " road");
                                    break;
                                case 4:
                                    Commands.RPChat("sme", player, $"made" + (characterData.Gender ? "" : "а") + " sniff");
                                    break;
                                case 5:
                                    Commands.RPChat("sme", player, $"blew" + (characterData.Gender ? "" : "а") + " Coconut");
                                    break;
                                case 6:
                                    Commands.RPChat("sme", player, $"sniffed" + (characterData.Gender ? "" : "а") + " dope");
                                    break;
                                case 7:
                                    Commands.RPChat("sme", player, $"sniffed" + (characterData.Gender ? "" : "а") + " coco");
                                    break;
                                case 8:
                                    Commands.RPChat("sme", player, $"grabbed" + (characterData.Gender ? "" : "а") + " coco");
                                    break;
                                default:
                                    Commands.RPChat("sme", player, $"sniffed" + (characterData.Gender ? "" : "а") + " coke");
                                    break;
                            }
                            sessionData.TimingsData.NextDrugs = DateTime.Now.AddMinutes(1.5);
                            UseEat(player, 9);
                    ...
                    case ItemId.Sprunk:
                        if (DateTime.Now > sessionData.TimingsData.NextEat)
                        {
                            ...
                            sessionData.TimingsData.NextEat = DateTime.Now.AddSeconds(5);
                            if (sessionData.ResistData.Time < 600) Trigger.ClientEvent(player, "stopScreenEffect", "PPFilter");
                            //Commands.RPChat("sme", player, $"drank" + (characterData.Gender ? "" : "а") + $" {ItemInfo.Name}");
                    ...
                    case ItemId.SimCard:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "The SIM card can be changed every 5 minutes", 4000);
                            return;
                        }
        ...
        public static void UseSmoke(ExtPlayer player, ItemId ItemId = ItemId.Vape)
        {
            try
            {
                ...
                Main.OnAntiAnim(player);
                //Commands.RPChat("sme", player, $"used" + (characterData.Gender ? "" : "а") + $" {name}");
        ...
        public static void UseBong(ExtPlayer player, float scale = 0.5f)
        {
            try
            {
                ...
                {
                    case 0:
                        Commands.RPChat("sme", player, $"up in smoke" + (characterData.Gender ? "" : "а") + " bong");
                        break;
                    case 1:
                        Commands.RPChat("sme", player, $"Smacked" + (characterData.Gender ? "" : "а") + " bong");
                        break;
                    case 2:
                        Commands.RPChat("sme", player, $"boiled" + (characterData.Gender ? "" : "а") + " bong");
                        break;
                    case 3:
                        Commands.RPChat("sme", player, $"smoked" + (characterData.Gender ? "" : "а") + " bong");
                        break;
                    case 4:
                        Commands.RPChat("sme", player, $"made" + (characterData.Gender ? "" : "а") + " bong zagazhiku");
                        break;
                    case 5:
                        Commands.RPChat("sme", player, $"blew" + (characterData.Gender ? "" : "а") + " bong");
                        break;
                    case 6:
                        Commands.RPChat("sme", player, $"dragged" + (characterData.Gender ? "" : "а") + " bong");
                        break;
                    case 7:
                        Commands.RPChat("sme", player, $"Stroked" + (characterData.Gender ? "" : "а") + " bong");
                        break;
                    case 8:
                        Commands.RPChat("sme", player, $"grabbed" + (characterData.Gender ? "" : "а") + " schmaltz from bongs");
                        break;
                    default:
                        Commands.RPChat("sme", player, $"smoked" + (characterData.Gender ? "" : "а") + " bong");
                        break;
            ...
            try
            {
                ...
                switch (ItemId)
                {
                    ...
                    case ItemId.Rose:
                        ...
                        {
                            //Commands.RPChat("sme", player, $"got it" + (characterData.Gender ? "" : "а") + $" {ItemInfo.Name}");
        ...
        public static bool ItemsDrop(ExtPlayer player, InventoryItemData Item, bool me = false, float posZ = -1f)
        {
            try
            {
                ...
                if (me)
                {
                    ...
                    xrnd = rnd.NextDouble();
                    yrnd = rnd.NextDouble();
                    //Commands.RPChat("sme", player, $"threw out" + (characterData.Gender ? "" : "а") + $" {itemInfo.Name}");
        ...
        public static void ItemsDropToEditor(ExtPlayer player, string arrayName, int index, float posX, float posY, float posZ, float rotX, float rotY, float rotZ)
        {
            try
            {
                ...
                sessionData.TimingsData.NextDropItem = DateTime.Now.AddMilliseconds(150);
                ItemsInfo ItemInfo = ItemsInfo[Item.ItemId];
                //Commands.RPChat("sme", player, $"put" + (characterData.Gender ? "" : "а") + $" {ItemInfo.Name}");
        ...
        public static void ConfirmTrade(ExtPlayer player)
        {
            try
            {
                ...
                if (!target.IsCharacterData())
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"The exchange has been cancelled", 3000);
                    ItemsClose(player, true);
                    return;
                }
                var targetSessionData = target.GetSessionData();
                ...
                if (TradeData.Money > 0)
                {
                    ...
                    Commands.RPChat("sme", player, "forwarded by" + (characterData.Gender ? "" : "а") + $" {Wallet.Format(TradeData.Money)}$ " + "{name}", target);
                ...
                if (TradeData.Money > 0)
                {
                    ...
                    Commands.RPChat("sme", target, "forwarded by" + (targetCharacterData.Gender ? "" : "а") + $" {Wallet.Format(TradeData.Money)}$ " + "{name}", player);
        ...
        public static void PlayerStats(ExtPlayer player, ExtPlayer target = null)
        {
            try
            {
                ...
                charData.Add(targetCharacterData.WeddingName.Length > 5 ? targetCharacterData.WeddingName : "No");//14
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Value == Item.Count)
                    {
                        ...
                        SetItemData(player, ArrayName, Index, new InventoryItemData(), true);
                        if (isBuy) EventSys.SendCoolMsg(player, "Marketplace", "Item purchase", LangFunc.GetText(LangType.Ru, DataName.YouBuy, "the item!", itemPrice), "", 5000);
                        ...
                        else Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.YouGetItem, "the item!"), 3000);
                        return;
                    }
        ...
        public static void SappeGame(ExtPlayer player, int amount)
        {
            try
            {
                ...
                UpdateData.RedBucks(player, -amount, msg: "Mini game Bomb Squad");
