    ...
    class Gopostal : Script
    {
        ...
        public static void OnJobGoPosta(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You don't work as a courier.", 3000);
                    return;
                }
        ...
        public static void GoPostal_onEntityEnterColShape(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "You don't have a package in your hand", 3000);
                    return;
                }
