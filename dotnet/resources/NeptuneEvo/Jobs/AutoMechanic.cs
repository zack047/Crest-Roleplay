        ...
        public static void mechanicRepair(ExtPlayer player, ExtPlayer target, int price)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    EventSys.SendCoolMsg(player,"Offer", "The Mechanic", LangFunc.GetText(LangType.Ru, DataName.MechanikRepairFrom, target.Value, MoneySystem.Wallet.Format(price)), "", 5000);
            ...
            try
            {
                ...
                if (qMain.GetQuestsLine(driver, Zdobich.QuestName) == (int)zdobich_quests.Stage11)
                {
                    ...
                    else
                    {
                        ...
                        Trigger.SendChatMessage(driver, $"You have earned ${driverSessionData.WorkData.PointsCount}. There's still ${500 - driverSessionData.WorkData.PointsCount}.");
                    }
                }
