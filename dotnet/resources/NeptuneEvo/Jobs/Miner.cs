    ...
    class Miner : Script
    {
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                Main.CreateBlip(new Main.BlipData(527, "Civic mine", new Vector3(124.831116, -397.94046, 41.263977), 4, true));
               ...
               // Main.CreateBlip(new Main.BlipData(618, "Скупщик драгоценностей", new Vector3(1054.20, -1952.84, 32.09), 70, true));
                ...
                MineStockLabel = (ExtTextLabel) NAPI.TextLabel.CreateTextLabel(Main.StringToU16($"~y~Storage condition:\n\nFossil coal {MineStockOres[0]} unit.\nIron ore {MineStockOres[1]} unit.\nSulfuric ore {MineStockOres[3]} unit.\nGemstones {MineStockOres[2] + MineStockOres[4] + MineStockOres[5]} unit."), new Vector3(-595.855, 2094.609, 131.4356), 5F, 0.5F, 0, new Color(255, 255, 255), true, 0);
                PlantStockLabel = (ExtTextLabel) NAPI.TextLabel.CreateTextLabel(Main.StringToU16($"~y~Storage condition:\n\nFossil coal {PlantStockOres[0]} unit.\nIron ore {PlantStockOres[1]} unit.\nGold Ore {PlantStockOres[2]} unit.\nGemstones {PlantStockOres[4] + PlantStockOres[5]} unit."), new Vector3(1066.399, -1980.138, 31.01464), 5F, 0.5F, 0, new Color(255, 255, 255), true, 0);

                PedSystem.Repository.CreateQuest("s_m_y_construct_01", new Vector3(-1637.993, -800.12006, 10.246064), 57.71f, title: "~y~NPC~w~ Mark\nOre buyer", colShapeEnums: ColShapeEnums.OresSell);
        ...
        public static void SaveMineStocks(int mine_index)
        {
            try
            {
                ...
                {
                    MineStockLabel.Text = Main.StringToU16($"~y~Storage condition:\n\nFossil coal {MineStockOres[0]} unit.\nIron ore {MineStockOres[1]} unit.\nSulfuric ore {MineStockOres[3]} unit.\nGemstones {MineStockOres[2] + MineStockOres[4] + MineStockOres[5]} unit.");
                }
                else if (mine_index == 2 && PlantStockLabel != null)
                {
                    PlantStockLabel.Text = Main.StringToU16($"~y~Storage condition:\n\nFossil coal {PlantStockOres[0]} unit.\nIron ore {PlantStockOres[1]} unit.\nGold Ore {PlantStockOres[2]} unit.\nGemstones {PlantStockOres[4] + PlantStockOres[5]} unit.");
                }
            }
            catch (Exception e)
            {
