...
<div class="popup__war">
    <div class="box-column">
        <div class="box-flex">
            ...
            <div class="box-column">
                <div class="popup__war_title">Declaration of War</div>
                <div class="popup__war_subtitle">Select options and start capturing</div>
            </div>
        </div>
        <div class="popup__war_smalltitle mt-40">{popupData.title}</div>
        <div class="popup__war_subtitle">Name of the object</div>
        <div class="popup__war_smalltitle">{popupData.owner}</div>
        <div class="popup__war_subtitle">Owner</div>
    </div>
    <div class="box-column">
        <div class="box-between mb-23">
            <div class="box-flex">
                ...
                <div class="box-column">
                    <div class="popup__war_headtitle">Setting up a business war</div>
                    <div class="popup__war_headsubtitle">Here you can configure all the parameters of the war for business</div>
                </div>
            </div>
       ...
       <div class="popup__war_element">
            <div class="box-column">
                <div class="popup__element_title">Type of battle</div>
                <div class="popup__element_subtitle">Select the desired type of battle</div>
            </div>
       ...
       <div class="popup__war_element">
            <div class="box-column">
               <div class="popup__element_title">The composition of the battle</div>
               <div class="popup__element_subtitle">Choose a suitable amount</div>
            </div>
            <div class="popup__war_selector">
       ...
       <div class="popup__war_element">
            <div class="box-column">
                <div class="popup__element_title">Type of weapon</div>
                <div class="popup__element_subtitle">Select the desired type of weapon</div>
            </div>
            <div class="popup__war_selector">
        ...
        <div class="popup__war_element">
            <div class="box-column">
                <div class="popup__element_title">The date of the battle</div>
                <div class="popup__element_subtitle">Choose the date of the turf war</div>
            </div>
        ...
        <div class="popup__war_button" on:click={onWar}>To score a war</div>
    </div>
