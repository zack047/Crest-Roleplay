...
<div id="war" bind:this={mainElement}>
    ...
    {#if selectItem}
        <div class="box-column zindex-10000">
            <div class="war__title">Territory map</div>
            <div class="war__subtitle">Conquer all the territories and become the king of the server!</div>
            <div class="box-column mt-auto">
                {#if viewData.wars && viewData.wars.length}
                    <div class="war__subtitle white">Closest shooters:</div>
        ...
        <div class="box-column fl-end zindex-10000">
            <div class="war__text_subtitle">Name of the object</div>
            <div class="war__text_title big">{selectItem.name}</div>
            <div class="war__text_subtitle">Owner</div>
            <div class="war__text_title">{selectItem.owner}</div>
            <div class="war__text_subtitle">Description</div>
            ...
            <div class="war__text_subtitle">Income per hour (each online faction member receives)</div>
            ...
            <div class="box-column mt-auto fl-end">
                <div class="war__subtitle white">Rating of families:</div>
