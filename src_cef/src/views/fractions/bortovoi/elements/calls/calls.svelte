    ...
    <div class="policecomputer__tablet">
        {#each new Array(20) as item}
            <div class="bortovoie__tablet_element noborder">
                ...
                <div class="descr">Shooting in the city area</div>
                <div class="button">
...
{#if true}
    ...
    <div class="policecomputer__info_subtitle">Rockford Hills, 12</div>
    <div class="policecomputer__info_title mt-20">{translateText('fractions', 'Сообщение')}:</div>
    <div class="policecomputer__info_subtitle">Shooting in the area of the city, two unknown persons. Judging by the shots they have automatic weapons.</div>
