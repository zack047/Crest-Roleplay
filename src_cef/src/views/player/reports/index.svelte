...
<div class="report-wrapper">
    <div class="ticketfull">
        <div class="ticketinside">
                ...
                <div class="answertoquestion">
                    <div class="textquestion">
                        <form action="javascript:void(0);">
                            <textarea class="user" onKeyPress={e => onKeyBan(e)} ref="answerBox" bind:value={answer} placeholder="Enter Reply to the Report..."  wrap="soft" cols="30" rows="5"></textarea>
                        </form>
                    </div>
                    <div class="buttonquestion">
                        <div class="box-flex">
                            <button class="buttonone" on:click={e => onSendAnswer($selected)}>Reply</button>
                            <button class="buttononek" on:click={e => onReturnReport($selected)}>Return</button>
                        </div>
            ...
            <div class="template">
                <p class="reporttext">Templates</p>
                ...
                <div class="texttempl">
                    <form action="">
                        <p>
                            <textarea class="user"  placeholder="Write your text for a new Template" cols="30" rows="5"></textarea>
                        </p>
                    </form>
                </div>
            </div>
