<script>
	...
	function CreateProgressBar() {
        let progressBarElement = document.querySelector("#ProgressBarKey");
        progressBarElement.style.width = '50px';  // Adjust to desired width
        progressBarElement.style.height = '50px'; // Adjust to desired height
		if (state.keyType === keyType[0] || state.keyType === keyType[1]) {
			...
			ProgressBarId.text.style.color = 'white';
		}
	};
