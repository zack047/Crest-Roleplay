                ...
                <div class="newphone__maps_client">
                    <div class="box-between">
                        <div class="box-column">
                            ...
                            <div class="gray">Distance {order.dist} м.</div>
                    ...
                    <div class="newphone__client_button" on:click={() => onTakeOrder (order.id)}>Take Order</div>
                </div>
            {/each}
        {:else}
            <div class="newphone__forbes_anon newphone__project_padding20">
                <div class="newphone__forbes_hidden noneelements"></div>
                <div class="gray">You don't have any active orders. But something will appear soon</div>
            </div>
        {/if}
    </div>
</div>