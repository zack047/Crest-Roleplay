...
<div class="newphone__maps_categories" style="background: linear-gradient(90deg, #FF8A00 0%, #D14E04 94.41%)" in:fade>
    ...
    <div class="newphone__maps_subcategories" bind:this={otherElement} use:setOtherElement>
        ...
        <div class="box-between newphone__project_padding20">
            <div class="newphone__maps_header">Call a Taxi</div>
        ...
        <div class="box-flex newphone__project_padding20 mb-0">
            ...
            <div class="newphone__maps_column">
                <div class="newphone__column_title">Pickup Location</div>
        ...
        <div class="newphone__maps_list" style="height: auto; min-height: auto; max-height: auto;">
            {#if selectTaxi && selectTaxi.isOrder}
                <div class="newphone__maps_title">Order Placed</div>
                <div class="newphone__maps_subtitle">Please wait in the area for your taxi,
                    if you leave the vicinity you will be fined.
                </div>
                <!--<div class="orange">Стоимость: 2500$</div>-->
                <div class="newphone__project_button" on:click={onCancelOrder}>Cancel</div>
            {:else}
                <div class="newphone__project_button" on:click={onOrder}>Order</div>
            {/if}
            <div class="orange box-center" on:click={closeMenu}>Close</div>
        </div>
        <HomeButton />
    </div>
</div>