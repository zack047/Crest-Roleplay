...
<div class="auth__characters_block" class:active={$selectIndex === charid} on:click={onSelectChar}>
    ...
    <div class="auth__characters_hover column">
        ...
        <InputCustom cl="auth__characters_input" setValue={(value) => FirstNameLocal = value} value={FirstNameLocal} placeholder="First Name" type="text" />
        <InputCustom cl="auth__characters_input" setValue={(value) => LastNameLocal = value} value={LastNameLocal} placeholder="Last Name" type="text" />
