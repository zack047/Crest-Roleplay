<script>
	...
	restoretype = true;
	restorelength = 6;
	placeholder = "Code aus der Email";
	restoreInput = "";
	} else if(step == 2) {
	...
	restorelength = 0;
	placeholder = "Versenden einer Nachricht...";
	restoreInput = "";
	}
	} else {
	...
	restorelength = 0;
	placeholder = "Autorisierung erfolgt";
	restoreInput = "";
	} else restoreInput = "";
	}
	return false;
        ...
        <div class="main__forms">
            ...
            <div class="box-flex">
                <div class="main__button main_button_size_large" style="width:100%;" on:click={onSubmitRestore}>
                    <div class="main__button_left box-center">Wiederherstellen</div>
            ...
            <div class="main__button main_button_size_large" style="width:100%; margin-top: 30px" on:click={() => OnSelectViews("Authentication")}>
                <div class="main__button_left box-center none">Zurück</div>
            </div>
        </div>
