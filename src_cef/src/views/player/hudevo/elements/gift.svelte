...
{#if isCase}
    <div class="gift1">
        <div class="gift_block"></div>
        <div class="gift_ico" style="background-image: url('{document.cloud}inventoryItems/items/{caseData [caseId].image}.png')"></div>
        <div class="gift_info">
            <h1>free case</h1>
            <p>через {caseData [caseId].hour}</p>
        </div>
    </div>
