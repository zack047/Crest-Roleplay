...
<div class="{classData}" class:bottom={bottom} class:active={laststate} class:keyPet={keyPet} class:keyDetector={keyDetector} class:keyDonate={keyDonate} class:pressed={state} class:disabled={disabled} class:nonactive={nonactive} on:keypress={() => {}} on:click={onClick} bind:this={buttonEl} style={style}>
    <slot/>
</div>