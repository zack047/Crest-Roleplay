<script>
    ...
    const changeWalkieTalkieVolume = (value) => {
        if (new Date().getTime() - eventsRefresh < 500) {
            window.notificationAdd(4, 9, 'Too fast', 1000);
            return false;
        }
    ...
    const swapChannel = (state) => {
        if (isGovFactionPlayer === false) {
			window.notificationAdd(4, 9, 'The general wave is available only for state. fractions', 1500);
            return;
        }
...
<div id="walkietalkie">
    <div class="walkietalkie__block">
        <div class="walkietalkie__danger" on:keypress={() => {}} on:click={() => dangerButton()}></div>
        <div class="walkietalkie__volume">
            <div class="walkietalkie__volume_box" on:keypress={() => {}} on:click={() => changeWalkieTalkieVolume(-1)}>-</div>
        ...
        <div class="walkietalkie__center">
            ...
            <div class="walkietalkie__button blue">
                <div class="walkitetalkie__button_small" on:keypress={() => {}} on:click={() => muteWalkieTalkieVoice()}>
                    <span class="walkie-nosound"/>
                </div>
            </div>
        </div>
        <div class="walkietalkie__buttons_list">
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => cancelSettings(true)}>1CH</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => swapChannel(1)}>↑</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => swapChannel(2)}>↓</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => closeWalkieTalkie()}>EXIT</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(1)}>1</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(2)}>2</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(3)}>3</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => cancelSettings()}>CLR</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(4)}>4</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(5)}>5</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(6)}>6</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeFrequency()}>ENT</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(7)}>7</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(8)}>8</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(9)}>9</div>
            <div class="walkietalkie__list_element" on:keypress={() => {}} on:click={() => changeChannel(0)}>0</div>
        </div>
    </div>
</div>