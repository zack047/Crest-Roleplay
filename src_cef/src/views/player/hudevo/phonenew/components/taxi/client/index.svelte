...
<div class="newphone__maps_categories" style="background: linear-gradient(90deg, #FF8A00 0%, #D14E04 94.41%)" in:fade>
    {#if selectTaxi && selectTaxi.driver}
        <div class="newphone__maps_price">
            <div class="box-column">
                <div class="newphone__maps_pricetitle">Driver:</div>
    ...
    <div class="newphone__maps_subcategories" bind:this={otherElement} use:setOtherElement>
        ...
        <div class="box-between newphone__project_padding20">
            <div class="newphone__maps_header">Taxi call</div>
        ...
        <div class="box-flex newphone__project_padding20 mb-0">
            ...
            <div class="newphone__maps_column">
                <div class="newphone__column_title">Place of arrival</div>
        ...
        <div class="newphone__maps_list" style="height: auto; min-height: auto; max-height: auto;">
            {#if selectTaxi && selectTaxi.isOrder}
                <div class="newphone__maps_title">The order is made</div>
                <div class="newphone__maps_subtitle">Expect the driver without leaving the call point. If you move away
                    then the order will be canceled, and a fine will be imposed on you.
                </div>
                <!--<div class="orange">Стоимость: 2500$</div>-->
                <div class="newphone__project_button" on:keypress={() => {}} on:click={onCancelOrder}>Cancel</div>
            {:else}
                <div class="newphone__project_button" on:keypress={() => {}} on:click={onOrder}>Order</div>
            {/if}
            <div class="orange box-center" on:keypress={() => {}} on:click={closeMenu}>Close</div>
        </div>
        <HomeButton />
    </div>
</div>