...
<div class="newphone__settings_content" in:fade>
    ...
    <div class="newphone__contacts_info newphone__project_padding16 b-white">
        ...
        <div class="box-column">
            ...
            <div>{$charSim == -1 ? "There is no SIM card" : $charSim}</div>
        </div>
    </div>
    <div class="newphone__contacts_list n-p big">
        <div class="newphone__settings_element">
            ...
            <div class="box-between w-1">
                ...
                <div class="sound__input-block switch-box" on:keypress={() => {}} on:click={updateAirStatus}>
                    <label class="switch">
        ...
        <div class="newphone__settings_element">
            ...
            <div class="box-between w-1">
                ...
                <div class="sound__input-block switch-box" on:keypress={() => {}} on:click={updateForbesVisible}>
                    <label class="switch">
        ...
        <div class="newphone__settings_element" on:keypress={() => {}} on:click={()=> onSelectedView("Wallpaper")}>
        ...
        <div class="newphone__settings_element" on:keypress={() => {}} on:click={()=> onSelectedView("SoundList")}>
        ...
        <div class="newphone__settings_element" on:keypress={() => {}} on:click={()=> onSelectedView("SmsList")}>
        ...
        {#if $charSim !== -1}
        <div class="newphone__settings_element bot" on:keypress={() => {}} on:click={onRemoveSim}>
            <div class="red">
