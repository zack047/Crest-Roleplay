<script>
	...
	[
		"https://radio.exsight-rp.com:8000/radio.mp3", // Общий
		"https://radio.exsight-rp.com:8010/radio.mp3", // Рэп/Хип-хоп
		"https://radio.exsight-rp.com:8040/radio.mp3", // Рок
		"https://radio.exsight-rp.com:8050/radio.mp3", // Фонк
		"https://radio.exsight-rp.com:8020/radio.mp3", // Поп
		"https://radio.exsight-rp.com:8060/radio.mp3"  // Чил
	];
        ...
        {#if selectPage == "radio"}
            ...
            <div class="box-between">
                ...
                <div class="sound__input-block switch-box">
                    <label class="switch" on:keypress={() => {}} on:click={updasteToggled}>
            ...
            <div class="box-between">
                ...
                <div class="box-flex">
                    <div class="newphone__radio_button" on:keypress={() => {}} on:click={() => changeVolume (-1)}>-</div>
                    <div class="width-12">{Math.round(SettingsList.VolumePhoneRadio / 10)}</div>
                    <div class="newphone__radio_button m-l" on:keypress={() => {}} on:click={() => changeVolume (+1)}>+</div>
                </div>
            </div>
            <div class="newphone__project_button radio" on:keypress={() => {}} on:click={()=> selectPage = "radioList"}>Change the station</div>
        {/if}
        {#if selectPage == "radioList"}
            <div class="newphone__project_title" in:fade>Выберите волну</div>
            <div class="newphone__radio_list">
			
                <div class="newphone__project_categorie" on:keypress={() => {}} on:click={() => setRadioStation (0)}>
                ...
                <div class="newphone__project_categorie" on:keypress={() => {}} on:click={() => setRadioStation (1)}>
				...
				<div class="newphone__project_categorie" on:keypress={() => {}} on:click={() => setRadioStation (2)}>
				...
				<div class="newphone__project_categorie" on:keypress={() => {}} on:click={() => setRadioStation (3)}>
                ...
                <div class="newphone__project_categorie" on:keypress={() => {}} on:click={() => setRadioStation (4)}>
                ...
                <div class="newphone__project_categorie" on:keypress={() => {}} on:click={() => setRadioStation (5)}>
            ...
            <div class="newphone__radio_back purple" on:keypress={() => {}} on:click={()=> selectPage = "radio"}>{translateText('player2', 'Назад')}</div>
        {/if}
    </div>
    <HomeButton />
</div>