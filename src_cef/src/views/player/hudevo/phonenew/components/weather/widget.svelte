...
<div class="newphone__mainmenu_weather" on:keypress={() => {}} on:click={() => currentPage.set("weather")} style={getWeatherIdToName(currentWeather.weatherId, currentWeather.hour) == ("night" || "nightcloud" || "nightfog" || "nightrain" || "nightthunder" || "nightsnow") ? "color:black" : ""}>
    ...
    <div class="newphone__mainmenu_name">Weather</div>
</div>