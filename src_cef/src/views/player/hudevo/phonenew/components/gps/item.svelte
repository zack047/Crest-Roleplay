...
<div class="newphone__maps_list" in:fade>
    <div class="newphone__maps_selected">
        ...
        <div class="box-column" on:keypress={() => {}} on:click={onStartPoint}>
            <div class="newphone__maps_headertitle">{data.name}</div>
            <div class="newphone__maps_headersubtitle">{data.dist} m.</div>
        </div>
    ...
    <div class="newphone__project_button" on:keypress={() => {}} on:click={onStartPoint}>{translateText('player2', 'Вперёд')}!</div>
</div>