    ...
    <div class="newphone__callview">
        ...
        <div class="newphone__callview_content">
            ...
            <div class="newphone__calview_center">
                ...
                <div class="newphone__dial_element" class:active={isMute} on:keypress={() => {}} on:click={updateMute}>
            ...
            <div class="newphone__calview_flex" class:isCall={!(!getComingPhone.isCall && !getComingPhone.isComing)}>
                <div class="box-column">
                    <div class="newphone__dial_element decline" on:keypress={() => {}} on:click={downPhone}>
                ...
                <div class="box-column">
                    <div class="newphone__dial_element call" on:keypress={() => {}} on:click={upPhone}>
