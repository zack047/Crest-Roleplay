...
<div class="newphone__contacts" in:fade>
    <div class="box-center box-between w-1 newphone__project_padding16">
        ...
        <div class="blue" on:keypress={() => {}} on:click={onClear}>{translateText('player2', 'Очистить')}</div>
    </div>
    {#if recents && recents.length > 0}
        <div class="newphone__contacts_list big">
            {#each recents as recent}
                <div class="newphone__recent_element" on:keypress={() => {}} on:click={() => onCall (recent.Number)} >
                    <div class="box-flex">
                    ...
                    <div class="box-flex">
                        ...
                        <div class="newphone__recent_info" on:keypress={() => {}} on:click={(e) => onInfo (e, recent.Number)} >
