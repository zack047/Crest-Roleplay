...
<div class="newphone__dial_popup" in:fade>
    <div class="newphone__dial_popupback">
        <div class="box-between">
            <div></div>
            <div class="phoneicons-add1" on:keypress={() => {}} on:click></div>
        </div>
        ...
        <div class="newphone__addcontact_element">
            ...
            <input type="text" class="newphone__addcontact_input" placeholder="Enter .." bind:value={nameValue} on:focus={onInputFocus} on:blur={onInputBlur}>
        </div>
        <div class="newphone__addcontact_element">
            <div class="gray">{translateText('player2', 'Номер')}</div>
            <input type="text" class="newphone__addcontact_input" placeholder="Enter .." bind:value={numberValue} on:focus={onInputFocus} on:blur={onInputBlur}>
        </div>
        <div class="newphone__addcontact_button" on:keypress={() => {}} on:click={onAddContact}>
