    ...
    <div class="newphone__maps mech" bind:this={mainElement} in:fade>
        ...
        <div class="newphone__maps_content">
            <div class="box-flex">
                ...
                <div class="newphone__maps_headertitleGPS newphone__shadow"><span class="truckercolor">Front</span>line Trucker</div>
            </div>
        </div>
            ...
            {#if isSelect}
                <div class="newphone__maps_price">
                    <div class="box-column">
                        <div class="newphone__maps_pricetitle">Client:</div>
