...
<div id="arenda-page">
    <div class="arenda" class:nonactive={SelectVehicle !== -1}>
        <div class="arenda-header">
            <div class="arenda-header__text">
                <div class="arenda-header__title">Rent</div>
                <div class="arenda-header__main-text">Need a vehicle to get around? Use your GPS to find similar places around the state that provide a variety of vehicles for rent, from boats and motorcycles to luxury cars in all colors! Rentals can be managed through your phone, and rentals will not reset when you leave the state if you still have some paid time left.</div>
            </div>
        ...
        <div class="arenda-main">
            ...
            <div class="arenda-main__element">
                ...
                <div class="arenda-main__price">
                    ...
                    ${format("money", GetRentCarCash (item.Price))} / hour
                </div>
    ...
    <div class="props-arenda">
        <div class="arenda-customize" transition:fade={{duration: 200}}>
            <div class="arenda-customize__title">Rent</div>
            ...
            <div class="arenda-customize__paragraph">Rental period / hour</div>
            ...
            {/if}
            <div class="arenda-customize__paragraph">Car color</div>
            ...
            <div class="arenda-customize__exit" on:click={() => SelectVehicle = -1}>Close</div>
        </div>
    </div>
    {/if}
</div>