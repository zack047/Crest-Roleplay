    ...
    let menu = [
        {
            ...
            items: [
                {name: translateText('player', 'Подработки'), component: Podrabotki, waypoint: "Hunting Shop"},
                {name: translateText('player', 'Электрик'), component: Electrician, waypoint: "Power Plant"},
                {name: translateText('player', 'Газонокосильщик'), component: Lawnmower, waypoint: "Lawn mower parking lot"},
                {name: translateText('player', 'Почтальон'), component: Postmen, waypoint: "Post Office"},
                {name: translateText('player', 'Водитель такси'), component: Taxi, waypoint: "Cab Park"},
                {name: translateText('player', 'Водитель автобуса'), component: Bus, waypoint: "Bus depot"},
                {name: translateText('player', 'Механик'), component: Mechanic, waypoint: "Parking lot for car mechanics"},
                {name: translateText('player', 'Дальнобойщик'), component: Trucker, waypoint: "Truckers parking lot"},
                {name: translateText('player', 'Инкассатор'), component: Coater, waypoint: "Parking for collectors"},
            ]
        },
        {
            open: false,
            ...
            items: [
                ...
                {name: translateText('player', 'Создание семьи'), component: CreateFraction, waypoint: "Families"}, //waypoint not work
        ...
        },
        {
            ...
            component: 'events',
            items: [
                {name: 'Daily Rewards', component: Everyday},
                {name: 'Gun Game', component: GunGame},
                {name: 'Air Drop', component: AirDrop, waypoint: "AirDrop"},
                {name: 'Street Racing', component: StreetCar},
                {name: 'Bizwar/Capture', component: BizCapt},
                {name: 'Gambling', component: Azart},
                {name: 'Helicopter Crash', component: HeliCrash},
            ]
        },
    ],
    active = {
