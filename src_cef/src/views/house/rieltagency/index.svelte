...
<div id="rielt">
    <div class="rielt__panel">
        <div class="rielt__header">Real estate agency</div>
        ...
        <div class="rielt__mainmenu_block">
            <div class="rielt__mainmenu_categorie big" class:active={SelectViews == "RieltHouses"} on:click={() => OnUpdatePage ("RieltHouses")}>
                ...
                <div class="box-column">
                    <div class="rielt__mainmenu_categorie-header">House</div>
                    <div class="rielt__gray">
                        Total in the state: <span class="rielt__white">{viewData.allHouse}</span>
                    </div>
                    <div class="rielt__gray">
                        Now on sale: <span class="rielt__white">{houseData.length}</span>
                    </div>
                </div>
            </div>
            <div class="rielt__mainmenu_categorie big" class:active={SelectViews == "RieltBusiness"} on:click={() => OnUpdatePage ("RieltBusiness")}>
                <div class="line"></div>
                <div class="box-column">
                    <div class="rielt__mainmenu_categorie-header">Businesses</div>
                    <div class="rielt__gray">
                        Total in the state: <span class="rielt__white">{viewData.allBusiness}</span>
                    </div>
                    <div class="rielt__gray">
                        Now on sale: <span class="rielt__white">{businessData.length}</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="rielt__mainmenu_center rielt">
            ...
            {:else}
                <div class="houseicon-time rielt__rielt_none">
                    <div class="absolute">
                        <div class="rielt__rielt_title font-36">On sale: 0</div>
                        <div class="rielt__rielt_subtitle">Expect</div>
                    </div>
                </div>
            {/if}
        </div>
        <div class="rielt__mainmenu_block">
            <div class="rielt__rielt_block-info">
                ...
                <div class="rielt__rielt_subtitle">Properties available</div>
            </div>
        </div>
    </div>
