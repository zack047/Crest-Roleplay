<script>
    ...
    let
        active = false,
        lists = [
            {title: 'Mafia', class: 'mafia', desc: translateText('games', 'Примерь на себя одну из ролей разбойного города и прими участие в легендарной игре!')},
            {title: 'Tanks', class: 'tanks', desc: translateText('games', 'Останься последним выжившим в хардкорном сражении на настоящих танках!')},
            {title: 'Airsoft', class: 'airsoft', desc: translateText('games', 'Прояви мастерство владения оружием в одном из увлекательных режимов на разных картах!')},
        ];
