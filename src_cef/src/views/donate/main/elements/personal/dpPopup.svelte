...
<div class="newdonate__special">
    <div class="newdonate__special-block" on:mouseenter on:mouseleave>
        ...
        <div class="newdonate__special-info">
            ...
            <div class="newdonate__special-gray">What is Included in the set?</div>
            ...
            <div class="newdonate__button_small" on:click={onBuy}>
                <div class="newdonate__button-text">Buy For {format("money", getPrice (popupData.price, popupData.id, $accountUnique))} CC</div>
            </div>
        </div>
    </div>
