...
<div id="newdonate__roulette">
    {#if caseData.price > 0}
    <div class="newdonate__roulette-title">Number of Cases</div>
    ...
    <div class="newdonate__roulette_hidden-box">
        ...
        <div class="newdonate__roulette-buttons">
            <div class="newdonate__button_small" on:click={() => onOpen()}>
                <div class="newdonate__button-text">Buy For {format("money", getPrice (caseData.price * currentCount, caseData.index, $accountUnique))} CC</div>
            </div>
        </div>
        {/if}
