        ...
        <div class="newdonate__header">
            <div class="newdonate__header-left">
                <div class="header__title-block">
                    <div class="shop-img"/>
                    <div class="newdonate__title">{('Menu')}</div>
                ...
                <div class="newdonate__subtitle">
                    {translateText('donate', 'Добро пожаловать! На этой странице представлены к приобретению за')}<b>CC</b>:{translateText('donate', 'кейсы, подписки, VIP-статусы, донат-пакеты, редкие вещи, смена имени/внешности, конвертация валюты и другие интересности')};
                </div>
            </div>
            <div class="newdonate__header-right">
                <div class="newdonate__header-coins">
                    <div class="newdonate__header-coin" on:click={() => SelectPopup = "PopupInfo" }>
                        ...
                        <div class="newdonate__header-info">{'Learn More'}</div>
                    </div>
                    <!--<div class="newdonate__header-coin">
                        ...
                        <div class="newdonate__header-info" on:click={() => SelectPopup = "PopupPrise" }>Learn More</div>
                    </div>-->
                </div>
               <div class="newdonate__button">
                    <div class="newdonate__button-main" on:click={() => SelectPopup = "PopupPayment" }>
                        <div class="newdonate__button-text">Donate at https://forums.gta5cypress.com/</div>
