...
export const itemsInfo = {
	...
	[ItemId.Bag]: {"Name":"Bag","Description":"Позволяет переносить в себе любые предметы.","Icon":"inv-item-backpack","Type":"Одежда","Stack":1,"functionType":1},
	...
	[ItemId.GasCan]: {"Name":"Canister","Description":"Можно заправить транспортное средство.","Icon":"inv-item-gasoline","Type":"Инструменты","Stack":2,"functionType":0},
	[ItemId.Crisps]: {"Name":"Chips","Description":"Закуска, восстанавливает 30% здоровья.","Icon":"inv-item-Chips","Type":"Еда","Stack":4,"functionType":6},
	[ItemId.Beer]: {"Name":"Beer","Description":"Пивка для рывка!","Icon":"inv-item-beer","Type":"Вода","Stack":5,"functionType":7},
	[ItemId.Pizza]: {"Name":"Pizza","Description":"Ммм... Пицца... Восстанавливает 30% здоровья.","Icon":"inv-item-pizza","Type":"Еда","Stack":3,"functionType":6},
	[ItemId.Burger]: {"Name":"Burger","Description":"Булка с котлеткой, восстанавливает 30% здоровья.","Icon":"inv-item-burger","Type":"Еда","Stack":4,"functionType":6},
	[ItemId.HotDog]: {"Name":"Hot-Doг","Description":"Булка с сосиской, восстанавливает 30% здоровья.","Icon":"inv-item-hot-dog","Type":"Еда","Stack":5,"functionType":6},
	[ItemId.Sandwich]: {"Name":"Sandwich","Description":"Несколько ломтиков хлеба и мяса, восстанавливает 30% здоровья.","Icon":"inv-item-sandwich","Type":"Еда","Stack":7,"functionType":6},
	...
	[ItemId.KeyRing]: {"Name":"A bunch of keys","Description":"Собирает все ключи в одну большую связку и экономит место в карманах!","Icon":"inv-item-key-2","Type":"Инструмент","Stack":1,"functionType":0},
	...
	[ItemId.Hammer]: {"Name":"Hammer","Description":"Молоток поможет вам в домашних делах.","Icon":"inv-item-Hammer","Type":"Оружие ближнего боя","Stack":1,"functionType":3},
	...
	[ItemId.Crowbar]: {"Name":"Scrap","Description":"Лом один из самых популярных инструментов.","Icon":"inv-item-crowbar","Type":"Оружие ближнего боя","Stack":1,"functionType":3},
	...
	[ItemId.Flashlight]: {"Name":"Flashlight","Description":"Яркий свет, поможет вам если вы потерялись в темном лесу.","Icon":"inv-item-Flashlight","Type":"Оружие ближнего боя","Stack":1,"functionType":3},
	...
	[ItemId.Ball]: {"Name":"Ball","Description":"Для игр с питомцем","Icon":"inv-item-ball","Type":"Особое","Stack":1,"functionType":2},
	...
	[ItemId.Bear]: {"Name":"Bear","Description":"Подари приятному человеку!","Icon":"inv-item-teddy-bear","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Note]: {"Name":"Note","Description":"С помощью записки можно оставить послание, передать какой-то секрет или другую важную информацию.","Icon":"inv-item-Note","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.LoveNote]: {"Name":"Love letter","Description":"Валентинка поможет описать свои теплые чувства к человеку.","Icon":"inv-item-LoveNote","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Vape]: {"Name":"Vape","Description":"Напас сочного вейпика всегда поднимает настроение.","Icon":"inv-item-Vape","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Rose]: {"Name":"Rose","Description":"Прекрасный подарок для любимого человека!","Icon":"inv-item-rose","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Barbell]: {"Name":"Barbell","Description":"Для желающих подравнять свою эстетику.","Icon":"inv-item-barbell","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Binoculars]: {"Name":"Binoculars","Description":"Позволяет видеть обьекты на дальнем расстоянии.","Icon":"inv-item-binoculars","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Bong]: {"Name":"Bong","Description":"Удобная штучка для употребления травки.","Icon":"inv-item-bong","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Umbrella]: {"Name":"Umbrella","Description":"Позволит укрыться от дождя и придаст стиля.","Icon":"inv-item-umbrella","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Camera]: {"Name":"Camera","Description":"Свет... Камера... Мотор!","Icon":"inv-item-camera","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Microphone]: {"Name":"Microphone","Description":"Предмет настоящего оратора.","Icon":"inv-item-microphone","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Guitar]: {"Name":"Guitar","Description":"Так и просится в руки... Сыграй что-нибудь!","Icon":"inv-item-guitar","Type":"Особое","Stack":1,"functionType":0},
	...
	[ItemId.Radio]: {"Name":"The radio","Description":"С помощью рации можно общаться с другими обладателями рации, или даже подслушать полицейскую или другую секретную волну.","Icon":"hud__icon-walkie-talkie","Type":"Особое","Stack":1,"functionType":0},
	...
	[ItemId.Hookah]: {"Name":"Hookah","Description":"Калюмбас для лютого распыха! Двойное яблочко и полетели...","Icon":"inv-item-hookah","Type":"Особое","Stack":1,"functionType":0},
	[ItemId.Case0]: {"Name":"Free daily case","Description":"Бесплатный кейс, можно получить спустя 3 часа игры.","Icon":"inv-item-case0","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case1]: {"Name":"Free gun case","Description":"Бесплатный кейс с оружием, можно получить спустя 5 часов игры.","Icon":"inv-item-case1","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case2]: {"Name":"Free Car Case","Description":"Бесплатный кейс с машинами, можно получить спустя 8 часов игры.","Icon":"inv-item-case2","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case3]: {"Name":"Standard case","Description":"Стандартный кейс со стандартными призами.","Icon":"inv-item-case3","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case4]: {"Name":"Weird case","Description":"Неплохой кейс для начинающих.","Icon":"inv-item-case4","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case5]: {"Name":"Special case","Description":"Сочный кейс, есть возможность серьёзно окупиться!","Icon":"inv-item-case5","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case6]: {"Name":"Rare case","Description":"Кейс с вещами и автомобилями повышенной редкости.","Icon":"inv-item-case6","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case7]: {"Name":"The case of the fierce","Description":"Очень лютый кейс. Суперприз - Bugatti, самый быстрый автомобиль.","Icon":"inv-item-case7","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case8]: {"Name":"Men's briefcase","Description":"Кейс с МУЖСКОЙ одеждой из донатного магазина одежды. Испытай удачу и будь стильным, или продай кому-то и будь богатым. А можешь и подарить...","Icon":"inv-item-case8","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case9]: {"Name":"Women's case","Description":"Кейс с ЖЕНСКОЙ одеждой из донатного магазина одежды. Отличный вариант, если хочется что-нибудь подарить.","Icon":"inv-item-case9","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case10]: {"Name":"Exotic case","Description":"Кейс с автомобилями из Exotic DonateRoom. Доната Редбаксовна одобряет!","Icon":"inv-item-case10","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case11]: {"Name":"Legendary case","Description":"Все или ничего! Хочешь рискнуть и стать обладателем легендарной кофты RedAge? Тогда крути кейс!","Icon":"inv-item-case11","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case12]: {"Name":"Interesting Case","Description":"Давно хочешь себе уникальную машину которая нигде не продается? Dodge Charger в этом кейсике!","Icon":"inv-item-case12","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case13]: {"Name":"Helicopter Case","Description":"Любишь смотреть на людей свысока? Пожалуй, для этого идеально подойдет вертолёт!","Icon":"inv-item-case13","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case14]: {"Name":"Armored Case","Description":"Классный новый кейс с модными бронированными тачками!","Icon":"inv-item-case14","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case15]: {"Name":"Exclusive Case","Description":"Крутой новый кейс с размещаемыми предметами!","Icon":"inv-item-case15","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case16]: {"Name":"Snowy Case [М]","Description":"Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. ","Icon":"inv-item-case16","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case17]: {"Name":"Amethyst Case [М]","Description":"Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. ","Icon":"inv-item-case17","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case18]: {"Name":"Holiday Case [М]","Description":"Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. ","Icon":"inv-item-case18","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case19]: {"Name":"Snowy Case [Ж]","Description":"Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. ","Icon":"inv-item-case19","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case20]: {"Name":"Amethyst Case [Ж]","Description":"Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. ","Icon":"inv-item-case20","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case21]: {"Name":"Holiday Case [Ж]","Description":"Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. ","Icon":"inv-item-case21","Type":"Особое","Stack":100,"functionType":9},
